...
<Term def={ "第6章 透明性：来点儿光在第6章 透明性：来点儿光中对应观察入口的可复核状态。" }>第6章 透明性：来点儿光</Term>、<Term def={"详细输出在第6章 透明性：来点儿光中对应状态展开的可复核状态。"}>详细输出</Term>、<Term def={"隐藏状态在第6章 透明性：来点儿光中对应故障定位的可复核状态。"}>隐藏状态</Term>、<Term def={"确定性在第6章 透明性：来点儿光中对应可编辑表示的可复核状态。"}>确定性</Term>、<Term def={"维护入口在第6章 透明性：来点儿光中对应恢复验证的可复核状态。"}>维护入口</Term>、<Term def={"恢复轨迹在第6章 透明性：来点儿光中对应观察入口的可复核状态。"}>恢复轨迹</Term>
