...
officialUnitId: cpr-03
---

import { Objectives } from "@/components/mdx/objectives";
import { Term } from "@/components/mdx/term";
import { CTypeSizeDiagram } from "@/components/mdx/diagrams/c-type-size-diagram";
import { Callout } from "@/components/mdx/callout";
import { IntegerRangeDiagram } from "@/components/mdx/diagrams/integer-range-diagram";
import { EscapeSequenceDiagram } from "@/components/mdx/diagrams/escape-sequence-diagram";
...
import { DataAndCDecisionLab, DataAndCMechanismMap, DataAndCFailureDiagram } from "@/components/mdx/c-primer-plus/data-and-c";
...
<DataAndCMechanismMap />

<DataAndCDecisionLab />

<DataAndCFailureDiagram />
...
在《数据和C》的官方单元 cpr-03 中，整数和浮点数连接本章第 2 组知识约束。学习时要同时说明它接受什么输入、改变什么状态、在何种边界失效；再以本章示例的编译诊断、固定输入输出或失败用例复核结论，不能只记术语名称。

<Attribution
  adaptedFrom="C Primer Plus, Sixth Edition, Chapter 3: Data and C"
