---
title: "Review of Coordinate Geometry"
type: B
section: "计算机图形学与渲染"
order: 1
description: "坐标系、向量基础、几何变换预备"
demo: true
math: false
...
Vulkan 把Review of Coordinate Geometry从驱动黑盒中抽出来，变成应用可控的显式流程。
这带来三个好处：
...
1. Review of Coordinate Geometry是 Vulkan 显式控制哲学的具体体现
...
<Answer>
练习 1：画出Review of Coordinate Geometry涉及的对象生命周期图，标注每个阶段的 API 调用。
</Answer>
...
<Attribution>
内容基于《Computer Graphics with OpenGL, 4th Edition (Hearn & Baker)》（https://www.pearson.com/en-gb/subject-catalog/p/computer-graphics-with-open-gl-pearson-new-international-edition/P200000004424/9781292037196）第 1 章整理重写，
代码示例为教学简化版本。
</Attribution>
