...
import {
  ChpInterfaceFailureStateMap,
  ChpValueOwnershipContractMap,
  ChpZeroCostAbstractionMap,
} from "@/components/mdx/cpp-high-performance/diagrams/brief-introduction-to-cpp";
