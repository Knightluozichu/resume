...
import { ConcurrencyDecisionLab, ConcurrencyMechanismMap, ConcurrencyFailureDiagram } from "@/components/mdx/cpp-high-performance/concurrency";
...
<ConcurrencyMechanismMap />

<ConcurrencyDecisionLab />

<ConcurrencyFailureDiagram />
