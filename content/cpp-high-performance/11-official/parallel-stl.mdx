...
import { ParallelStlDecisionLab, ParallelStlMechanismMap, ParallelStlFailureDiagram } from "@/components/mdx/cpp-high-performance/parallel-stl";
...
<ParallelStlMechanismMap />

<ParallelStlDecisionLab />

<ParallelStlFailureDiagram />
