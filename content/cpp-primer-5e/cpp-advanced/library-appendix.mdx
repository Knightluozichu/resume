...
import {
  CppAlgorithmSelectionDiagram,
  CppLibraryHeaderMapDiagram,
  CppRandomCatalogDiagram,
} from "@/components/mdx/cpp-primer-5e/diagrams/library-appendix";
...
<Attribution source="C++ Primer, Fifth Edition, Appendix A: The Library" />
