...
import { ServerSynchronizationLab, ServerSynchronizationMechanismMap, ServerSynchronizationFailureDiagram } from "@/components/mdx/cpp-server-essence/multithreading-resource-sync";
