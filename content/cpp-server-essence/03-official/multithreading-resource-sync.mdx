...
import {
  CseSynchronizationPrimitiveLab,
  CseThreadLifecycleLab,
  CseThreadPoolBackpressureLab,
} from "@/components/mdx/cpp-server-essence/diagrams/multithreading-resource-sync";
