...
import { ProtocolFramingLab, ProtocolFramingMechanismMap, ProtocolFramingFailureDiagram } from "@/components/mdx/cpp-server-essence/network-protocol-design";
...
<ProtocolFramingMechanismMap />

<ProtocolFramingLab />

<ProtocolFramingFailureDiagram />
