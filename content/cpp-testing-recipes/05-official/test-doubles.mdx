...
import { TestDoublesDecisionLab, TestDoublesMechanismMap, TestDoublesFailureDiagram } from "@/components/mdx/cpp-testing-recipes/test-doubles";
...
<TestDoublesMechanismMap />

<TestDoublesDecisionLab />

<TestDoublesFailureDiagram />
