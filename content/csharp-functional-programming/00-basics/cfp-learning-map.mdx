...
import { CfpLearningMapDecisionLab, CfpLearningMapMechanismMap, CfpLearningMapFailureDiagram } from "@/components/mdx/csharp-functional-programming/cfp-learning-map";
...
<CfpLearningMapMechanismMap />

<CfpLearningMapDecisionLab />

<CfpLearningMapFailureDiagram />
...
<Stepper>
  <Step title="切换value、compose、effect与operate"></Step>
...
<Stepper>
  <Step title="切换new、domain、async与review路线"></Step>
...
<Attribution
  adaptedFrom="Functional Programming in C#, First Edition, publisher table of contents and 3-part structure"
