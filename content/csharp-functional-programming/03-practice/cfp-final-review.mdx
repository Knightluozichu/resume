...
import { CfpFinalReviewDecisionLab, CfpFinalReviewMechanismMap, CfpFinalReviewFailureDiagram } from "@/components/mdx/csharp-functional-programming/cfp-final-review";
...
<CfpFinalReviewMechanismMap />

<CfpFinalReviewDecisionLab />

<CfpFinalReviewFailureDiagram />
...
<Stepper>
  <Step title="切换input、decide、execute与publish"></Step>
...
<Stepper>
  <Step title="切换absence、expected fail、async/stream与state/concurrency"></Step>
...
<Attribution
  adaptedFrom="Functional Programming in C#, First Edition, all 15 chapters and publisher table of contents"
  adaptedUrl="https://livebook.manning.com/book/functional-programming-in-c-sharp/table-of-contents"
