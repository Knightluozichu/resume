...
import { ReactiveDataStreamsDecisionLab, ReactiveDataStreamsMechanismMap, ReactiveDataStreamsFailureDiagram } from "@/components/mdx/csharp-functional-programming/reactive-data-streams";
...
<ReactiveDataStreamsDecisionLab />
...
<Stepper>
  <Step title="切换OnNext、OnError、OnCompleted与Dispose"></Step>
...
<Stepper>
  <Step title="切换Select、Where、Merge与Switch"></Step>
...
<Stepper>
  <Step title="切换Buffer、Scan、Timeout与Retry"></Step>
...
<Attribution
  adaptedFrom="Functional Programming in C#, First Edition, Chapter 14: Data streams and the Reactive Extensions"
  adaptedUrl="https://livebook.manning.com/book/functional-programming-in-c-sharp/chapter-14"
