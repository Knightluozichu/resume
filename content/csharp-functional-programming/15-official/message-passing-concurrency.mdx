...
import { CfpLobTopologyLab, CfpMailboxProtocolLab, CfpSharedStateChoiceLab } from "@/components/mdx/csharp-functional-programming/diagrams/message-passing-concurrency";
...
<Stepper>
  <Step title="切换lock、atomic、immutable与agent"><CfpSharedStateChoiceLab /></Step>
...
<Stepper>
  <Step title="切换send、handle、reply与fail"><CfpMailboxProtocolLab /></Step>
...
<Stepper>
  <Step title="切换account、pricing、risk与gateway"><CfpLobTopologyLab /></Step>
...
<Attribution adaptedFrom="Functional Programming in C#, First Edition, Chapter 15: An introduction to message-passing concurrency" adaptedUrl="https://livebook.manning.com/book/functional-programming-in-c-sharp/chapter-15" />
