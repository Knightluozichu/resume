...
import { CqcFinalReviewDecisionLab, CqcFinalReviewMechanismMap, CqcFinalReviewFailureDiagram } from "@/components/mdx/csharp-quality-code/cqc-final-review";
...
<CqcFinalReviewMechanismMap />

<CqcFinalReviewDecisionLab />

<CqcFinalReviewFailureDiagram />
...
<Attribution
  adaptedFrom="编写高质量代码：改善C#程序的157个建议，第一版官方12章目录与整书验收"
