...
import { CqcContractDocumentationLab, CqcReadableSurfaceLab, CqcRefactoringEvidenceLab } from "@/components/mdx/csharp-quality-code/diagrams/clean-code";
