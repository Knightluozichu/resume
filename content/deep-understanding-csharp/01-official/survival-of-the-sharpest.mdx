...
import { SurvivalOfTheSharpestDecisionLab, SurvivalOfTheSharpestMechanismMap, SurvivalOfTheSharpestFailureDiagram } from "@/components/mdx/deep-understanding-csharp/survival-of-the-sharpest";
...
<Stepper>
  <Step title="切换type、concision、LINQ、async与efficiency压力"></Step>
...
<Stepper>
  <Step title="切换language、platform、community与book演进"></Step>
...
<Stepper>
  <Step title="切换version、runtime、lowering与production证据"></Step>
...
<Attribution
  adaptedFrom="C# in Depth, Fourth Edition, Chapter 1: Survival of the sharpest"
  adaptedUrl="https://livebook.manning.com/book/c-sharp-in-depth-fourth-edition/chapter-1"
