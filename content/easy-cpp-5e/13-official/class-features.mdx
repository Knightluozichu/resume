...
import { EasyCppClassFeaturesContractLab, EasyCppClassFeaturesTraceLab, EasyCppClassFeaturesFaultLab } from "@/components/mdx/easy-cpp-5e/v2/class-features";
...
“Lesson 13：类的功能”以 [SB Creative 出版社书页](https://www.sbcr.jp/product/4797392593/)核定高桥麻奈著、第 5 版、2017 年 6 月 14 日发行、ISBN 978-4-7973-9259-3；出版社页面标 596 页。[CiNii Books 书目与 16 课目录](https://ci.nii.ac.jp/ncid/BB23841999)记录正文 xxiii+571 页，[日本国会图书馆书目](https://ndlsearch.ndl.go.jp/books/R100000002-I028210091)记录 571 页。页数口径存在前置页差异，因此本课程不拿页码充当目录证据。

“Lesson 13：类的功能”的中文说明、示例、交互、练习和答案均为独立教学重写。公开资料只确认 16 个 Lesson 标题；本页列出的细分概念是课程教学映射，不冒充原书逐级小节。技术规则参考 [ISO C++ 标准入口](https://isocpp.org/std/the-standard)复核，但 2017 年教材的 Visual Studio 2017 语境不会被静默升级为 C++23；现代写法只能明确标为迁移说明。
...
<EasyCppClassFeaturesContractLab />

<EasyCppClassFeaturesTraceLab />

<EasyCppClassFeaturesFaultLab />
{/* ECP_EVIDENCE_V2_END */}
