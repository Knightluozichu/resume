...
section: "计算机图形学与渲染"
order: 1
description: "全局光照问题定义、直接光照与间接光照"
demo: true
math: false
...
- 能回答：全局光照问题定义与直接光照与间接光照之间的关系是什么？

</Objectives>

## 为什么需要Introduction

Global Illumination Compendium将Introduction作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
全局光照问题定义、直接光照与间接光照正是这一哲学在特定领域的具体体现。
...
<Attribution>
内容基于《Global Illumination Compendium》（https://books.google.com/books?id=KodRAAAAMAAJ）第 1 章整理重写，
代码示例为教学简化版本。
</Attribution>
