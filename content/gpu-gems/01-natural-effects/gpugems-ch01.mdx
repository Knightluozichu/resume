---
title: "Chapter 1: Natural Effects"
type: B
section: "计算机图形学与渲染"
order: 1
description: "GPU Gems Part: Natural Effects, Chapter 1"
demo: true
math: false
...
Vulkan 把Chapter 1: Natural Effects从驱动黑盒中抽出来，变成应用可控的显式流程。
这带来三个好处：
...
<Answer>
练习 1：画出Chapter 1: Natural Effects涉及的对象生命周期图，标注每个阶段的 API 调用。
</Answer>
...
<Attribution>
内容基于《GPU Gems: Programming Techniques, Tips, and Tricks for Real-Time Graphics》（https://developer.nvidia.com/gpugems）第 1 章整理重写，
代码示例为教学简化版本。
</Attribution>
