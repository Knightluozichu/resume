...
officialUnitId: ilh-09-http-extensions
---
...
import { Ilh09HttpExtensionsDecisionLab, Ilh09HttpExtensionsMechanismMap, Ilh09HttpExtensionsFailureDiagram } from "@/components/mdx/illustrated-http/ilh-09-http-extensions";
...
<Ilh09HttpExtensionsMechanismMap />

<Ilh09HttpExtensionsDecisionLab />
...
<Answer>
  围绕 第9章 基于HTTP的功能追加协议 固定 URI、客户端、网络、服务器数据和操作，并且只改变一个方法、首部、主体、连接、Cookie 或输入上下文；保存完整请求响应，比较状态、缓存/会话和最终副作用。
</Answer>
