...
<Term def="容器是第1章 Kubernetes 介绍的第1个核心概念，必须同时说明Kubernetes 1.8对象、控制循环、故障边界和观测证据">
  容器
</Term>
、
<Term def="控制面是第1章 Kubernetes 介绍的第2个核心概念，必须同时说明Kubernetes 1.8对象、控制循环、故障边界和观测证据">
  控制面
</Term>
、
<Term def="工作节点是第1章 Kubernetes 介绍的第3个核心概念，必须同时说明Kubernetes 1.8对象、控制循环、故障边界和观测证据">
  工作节点
</Term>
、
<Term def="期望状态是第1章 Kubernetes 介绍的第4个核心概念，必须同时说明Kubernetes 1.8对象、控制循环、故障边界和观测证据">
  期望状态
</Term>
、
<Term def="自愈是第1章 Kubernetes 介绍的第5个核心概念，必须同时说明Kubernetes 1.8对象、控制循环、故障边界和观测证据">
  自愈
</Term>
