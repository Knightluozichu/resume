...
import {
  K8s01IntroductionObjectLab,
  K8s01IntroductionReconcileLab,
  K8s01IntroductionEvidenceLab,
} from "@/components/mdx/kubernetes-in-action/diagrams/k8s-01-introduction";
