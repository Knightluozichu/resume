...
section: "学习地图"
order: 0
description: "按第一版前言、数学符号、8章、参考文献与索引冻结127个正式目录层级，建立从Transformer、数据和分布式训练到SFT、RLHF、应用与评估的完整依赖图。"
demo: true
math: true
...
、、、、、共同构成本页坐标。按第一版前言、数学符号、8章、参考文献与索引冻结127个正式目录层级，建立从Transformer、数据和分布式训练到SFT、RLHF、应用与评估的完整依赖图。
