...
import {
  Mxrw01IntroductionMapLab,
  Mxrw01IntroductionExperimentLab,
  Mxrw01IntroductionEvidenceLab,
} from "@/components/mdx/mobile-xr-web-optimization/diagrams/mxrw-01-introduction";
