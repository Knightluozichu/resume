...
<Term
  def={
    "Chapter 5 Reactive and Hybrid Agents在Chapter 5 Reactive and Hybrid Agents中对应读取环境的可复核变量。"
  }
>
...
<Term
  def={
    "包容架构在Chapter 5 Reactive and Hybrid Agents中对应触发反应的可复核变量。"
  }
>
  包容架构
</Term>
...
<Term
  def={
    "情境自动机在Chapter 5 Reactive and Hybrid Agents中对应更新计划的可复核变量。"
  }
>
  情境自动机
</Term>
...
<Term
  def={
    "反应限制在Chapter 5 Reactive and Hybrid Agents中对应层间仲裁的可复核变量。"
  }
>
  反应限制
</Term>
...
<Term
  def={
    "混合分层在Chapter 5 Reactive and Hybrid Agents中对应执行回放的可复核变量。"
  }
>
  混合分层
</Term>
、
<Term
  def={"仲裁在Chapter 5 Reactive and Hybrid Agents中对应读取环境的可复核变量。"}
>
  仲裁
</Term>
