...
<Term
  def={
    "Chapter 11 Multiagent Interactions在Chapter 11 Multiagent Interactions中对应列行动集的可复核变量。"
  }
>
...
<Term
  def={
    "效用偏好在Chapter 11 Multiagent Interactions中对应填写收益的可复核变量。"
  }
>
  效用偏好
</Term>
...
<Term
  def={
    "占优策略在Chapter 11 Multiagent Interactions中对应标最佳响应的可复核变量。"
  }
>
  占优策略
</Term>
、
<Term
  def={"纳什均衡在Chapter 11 Multiagent Interactions中对应找均衡的可复核变量。"}
>
  纳什均衡
</Term>
、
<Term
  def={"帕累托在Chapter 11 Multiagent Interactions中对应比较效率的可复核变量。"}
>
  帕累托
</Term>
、
<Term
  def={
    "社会福利在Chapter 11 Multiagent Interactions中对应列行动集的可复核变量。"
  }
>
  社会福利
</Term>
