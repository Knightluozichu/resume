...
<Term
  def={
    "Chapter 13 Forming Coalitions在Chapter 13 Forming Coalitions中对应定义联盟值的可复核变量。"
  }
>
...
、
<Term
  def={"合作博弈在Chapter 13 Forming Coalitions中对应枚举结构的可复核变量。"}
>
  合作博弈
</Term>
、
<Term def={"核心在Chapter 13 Forming Coalitions中对应检查核心的可复核变量。"}>
  核心
</Term>
、
<Term
  def={"Shapley值在Chapter 13 Forming Coalitions中对应计算贡献的可复核变量。"}
>
  Shapley值
</Term>
、
<Term
  def={"紧凑表示在Chapter 13 Forming Coalitions中对应比较分配的可复核变量。"}
>
  紧凑表示
</Term>
、
<Term
  def={"联盟结构在Chapter 13 Forming Coalitions中对应定义联盟值的可复核变量。"}
>
  联盟结构
</Term>
