...
import { MasInteractionLab } from "@/components/mdx/multiagent-systems/v2/mas-13-forming-coalitions";
...
<Answer>
按每个成员在所有加入顺序下的平均边际贡献分配，唯一满足公理的解。
</Answer>

**问题 2：** 核心为空意味着什么？

<Answer>
不存在让任何子联盟都不愿退出的分配，大联盟不稳定。
</Answer>

**问题 3：** 计算一个三人合作博弈的 Shapley 值。（独立实现）

<Answer>
枚举 6 种加入顺序的边际贡献取平均，验证效率性。
</Answer>
