---
title: "Geometry and Tessellation Shaders"
type: B
section: "计算机图形学与渲染"
order: 10
description: "几何着色器、细分控制与求值"
demo: true
math: false
...
- 能用自己的话解释Geometry and Tessellation Shaders的核心概念与设计动机
- 能看懂并独立修改相关的 Vulkan API 调用代码
- 能回答：几何着色器与细分控制与求值之间的关系是什么？

</Objectives>

## 为什么需要Geometry and Tessellation Shaders

OpenGL Programming Guide: The Official Guide to Learning OpenGL, 9th Edition将Geometry and Tessellation Shaders作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
Vulkan 把Geometry and Tessellation Shaders从驱动黑盒中抽出来，变成应用可控的显式流程。
这带来三个好处：
...
Vulkan 中所有资源都是不透明句柄（handle）。Geometry and Tessellation Shaders涉及的对象遵循统一的生命周期：
...
在 Vulkan 中使用Geometry and Tessellation Shaders相关功能前，必须完成：
...
// 录制与Geometry and Tessellation Shaders相关的命令
// ... 具体的 vkCmd* 调用 ...
...
启用验证层后，Geometry and Tessellation Shaders相关的常见错误会被捕获：
...
1. Geometry and Tessellation Shaders是 Vulkan 显式控制哲学的具体体现
...
<Answer>
练习 1：画出Geometry and Tessellation Shaders涉及的对象生命周期图，标注每个阶段的 API 调用。
</Answer>
...
<Attribution>
内容基于《OpenGL Programming Guide: The Official Guide to Learning OpenGL, 9th Edition》（https://www.informit.com/store/opengl-programming-guide-the-official-guide-to-learning-9780134495552）第 10 章整理重写，
代码示例为教学简化版本。
</Attribution>
