...
section: "计算机图形学与渲染"
order: 10
description: "FBO、渲染目标、离屏渲染、Blit"
demo: true
math: false
...
- 能回答：FBO与渲染目标之间的关系是什么？

</Objectives>

## 为什么需要Framebuffers and Attachments

OpenGL SuperBible: Comprehensive Tutorial and Reference, 7th Edition将Framebuffers and Attachments作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
FBO、渲染目标、离屏渲染、Blit正是这一哲学在特定领域的具体体现。
...
<Attribution>
内容基于《OpenGL SuperBible: Comprehensive Tutorial and Reference, 7th Edition》（https://www.informit.com/store/opengl-superbible-comprehensive-tutorial-and-reference-9780134193137）第 10 章整理重写，
代码示例为教学简化版本。
</Attribution>
