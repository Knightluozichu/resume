...
section: "计算机图形学与渲染"
order: 15
description: "工作组、共享内存、Barrier、GPGPU"
demo: true
math: false
...
- 能回答：工作组与共享内存之间的关系是什么？

</Objectives>

## 为什么需要Compute Shaders

OpenGL SuperBible: Comprehensive Tutorial and Reference, 7th Edition将Compute Shaders作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
工作组、共享内存、Barrier、GPGPU正是这一哲学在特定领域的具体体现。
...
<Attribution>
内容基于《OpenGL SuperBible: Comprehensive Tutorial and Reference, 7th Edition》（https://www.informit.com/store/opengl-superbible-comprehensive-tutorial-and-reference-9780134193137）第 15 章整理重写，
代码示例为教学简化版本。
</Attribution>
