...
section: "计算机图形学与渲染"
order: 1
description: "Literate Programming、光线追踪概述、pbrt系统架构"
demo: true
math: false
...
- 能回答：Literate Programming与光线追踪概述之间的关系是什么？

</Objectives>

## 为什么需要Introduction

Physically Based Rendering: From Theory to Implementation, 4th Edition将Introduction作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
Literate Programming、光线追踪概述、pbrt系统架构正是这一哲学在特定领域的具体体现。
...
<Attribution>
内容基于《Physically Based Rendering: From Theory to Implementation, 4th Edition》（https://pbr-book.org/4ed/）第 1 章整理重写，
代码示例为教学简化版本。
</Attribution>
