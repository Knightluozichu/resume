...
import { Poeaa24Pattern16EmbeddedValueDiagram } from "@/components/mdx/poeaa-enterprise-patterns/diagrams/poeaa24-pattern-16-embedded-value-diagram";
...
<Stepper>
  <Step title="1. 保留对象语义">
    ...
    <Poeaa24Pattern16EmbeddedValueDiagram focus="object" interactive={false} />
  ...
  <Step title="2. 展开到所有者表">
    ...
    <Poeaa24Pattern16EmbeddedValueDiagram focus="columns" interactive={false} />
  ...
  <Step title="3. 从列重建并校验">
    ...
    <Poeaa24Pattern16EmbeddedValueDiagram focus="round-trip" interactive={false} />
