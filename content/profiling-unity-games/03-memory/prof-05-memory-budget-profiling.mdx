...
import {
  Prof05MemoryBudgetProfilingMapLab,
  Prof05MemoryBudgetProfilingExperimentLab,
  Prof05MemoryBudgetProfilingEvidenceLab,
} from "@/components/mdx/profiling-unity-games/diagrams/prof-05-memory-budget-profiling";
