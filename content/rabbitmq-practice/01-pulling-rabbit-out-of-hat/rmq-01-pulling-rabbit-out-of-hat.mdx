...
<Term def="消息通信是“从消息系统历史、AMQP开放协议、RabbitMQ选择与UNIX安装建立RabbitMQ 2.7时代的运行基线”中的第1个RabbitMQ 2.7概念，定义必须同时给出AMQP状态、故障边界和可观测证据">
  消息通信
</Term>
、
<Term def="AMQP是“从消息系统历史、AMQP开放协议、RabbitMQ选择与UNIX安装建立RabbitMQ 2.7时代的运行基线”中的第2个RabbitMQ 2.7概念，定义必须同时给出AMQP状态、故障边界和可观测证据">
  AMQP
</Term>
、
<Term def="RabbitMQ 2.7是“从消息系统历史、AMQP开放协议、RabbitMQ选择与UNIX安装建立RabbitMQ 2.7时代的运行基线”中的第3个RabbitMQ 2.7概念，定义必须同时给出AMQP状态、故障边界和可观测证据">
  RabbitMQ 2.7
</Term>
、
<Term def="Erlang是“从消息系统历史、AMQP开放协议、RabbitMQ选择与UNIX安装建立RabbitMQ 2.7时代的运行基线”中的第4个RabbitMQ 2.7概念，定义必须同时给出AMQP状态、故障边界和可观测证据">
  Erlang
</Term>
、
<Term def="节点是“从消息系统历史、AMQP开放协议、RabbitMQ选择与UNIX安装建立RabbitMQ 2.7时代的运行基线”中的第5个RabbitMQ 2.7概念，定义必须同时给出AMQP状态、故障边界和可观测证据">
  节点
</Term>
