...
- 能回答：实时渲染概述与本书结构之间的关系是什么？

</Objectives>

## 为什么需要Introduction

Real-Time Rendering, Fourth Edition将Introduction作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
实时渲染概述、本书结构、符号约定正是这一哲学在特定领域的具体体现。
...
<Attribution>
内容基于《Real-Time Rendering, Fourth Edition》（https://www.realtimerendering.com/）第 1 章整理重写，
代码示例为教学简化版本。
</Attribution>
