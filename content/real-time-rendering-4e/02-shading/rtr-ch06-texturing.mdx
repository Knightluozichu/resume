...
section: "计算机图形学与渲染"
order: 6
description: "纹理映射、MIP链、各向异性、POM、纹理数组"
demo: true
math: false
...
- 能回答：纹理映射与MIP链之间的关系是什么？

</Objectives>

## 为什么需要Texturing

Real-Time Rendering, Fourth Edition将Texturing作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
纹理映射、MIP链、各向异性、POM、纹理数组正是这一哲学在特定领域的具体体现。
...
<Attribution>
内容基于《Real-Time Rendering, Fourth Edition》（https://www.realtimerendering.com/）第 6 章整理重写，
代码示例为教学简化版本。
</Attribution>
