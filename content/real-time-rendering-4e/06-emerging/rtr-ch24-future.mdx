...
section: "计算机图形学与渲染"
order: 24
description: "实时光线追踪、神经网络渲染、虚拟几何体"
demo: true
math: false
...
- 能回答：实时光线追踪与神经网络渲染之间的关系是什么？

</Objectives>

## 为什么需要The Future

Real-Time Rendering, Fourth Edition将The Future作为独立章节，是因为它解决了 Vulkan 编程中一个不可绕过的核心问题。
...
实时光线追踪、神经网络渲染、虚拟几何体正是这一哲学在特定领域的具体体现。
...
<Attribution>
内容基于《Real-Time Rendering, Fourth Edition》（https://www.realtimerendering.com/）第 24 章整理重写，
代码示例为教学简化版本。
</Attribution>
