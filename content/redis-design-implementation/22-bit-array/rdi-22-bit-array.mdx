...
import { RdiStructureLab } from "@/components/mdx/redis-design-implementation/v2/rdi-22-bit-array";
...
<Answer>
每元素 1 位对 8 位，理论省 8 倍；5 亿用户日活标记只占约 60MB。
</Answer>

**问题 2：** BITOP 的典型应用场景？

<Answer>
多天位图做 AND 求连续活跃、OR 求任意活跃，一次命令完成集合运算，免数据传输。
</Answer>

**问题 3：** 用位图实现 7 天连续签到统计。（独立实现）

<Answer>
每天一键 SETBIT uid 1，BITOP AND 七天键，BITCOUNT 得连续天数，评估键大小。
</Answer>
