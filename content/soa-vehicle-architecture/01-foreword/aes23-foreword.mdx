...
<Term def="课程坐标是序：汽车电子与软件架构课程坐标的第1个复核坐标，必须绑定目录位置、系统对象和版本。">
  课程坐标
</Term>
、
<Term def="电子电气架构是序：汽车电子与软件架构课程坐标的第2个复核坐标，必须记录拓扑、输入输出和责任边界。">
  电子电气架构
</Term>
、
<Term def="软件定义汽车是序：汽车电子与软件架构课程坐标的第3个复核坐标，必须说明协议、状态或配置转换。">
  软件定义汽车
</Term>
、
<Term def="系统边界是序：汽车电子与软件架构课程坐标的第4个复核坐标，必须覆盖正常、边界和单故障样本。">
  系统边界
</Term>
、
<Term def="工程证据是序：汽车电子与软件架构课程坐标的第5个复核坐标，必须支持独立重放与安全回退。">
  工程证据
</Term>
