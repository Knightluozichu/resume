...
const PAGES = [
  ...
  // AI Agent 开发实战
  "/learn/ai-agent-dev/foundations/what-is-agent",
  "/learn/ai-agent-dev/foundations/llm-brain",
  "/learn/ai-agent-dev/foundations/prompting-roles",
  "/learn/ai-agent-dev/core-mechanisms/react-loop",
  "/learn/ai-agent-dev/core-mechanisms/tool-calling",
  "/learn/ai-agent-dev/core-mechanisms/memory",
  "/learn/ai-agent-dev/core-mechanisms/planning",
  "/learn/ai-agent-dev/knowledge-rag/rag",
  "/learn/ai-agent-dev/knowledge-rag/context-engineering",
  "/learn/ai-agent-dev/multi-agent/multi-agent-patterns",
  "/learn/ai-agent-dev/multi-agent/orchestration",
  "/learn/ai-agent-dev/enterprise/evaluation-observability",
  "/learn/ai-agent-dev/enterprise/safety-guardrails",
  "/learn/ai-agent-dev/enterprise/production-deployment",
  // C++ Primer
  ...
  "/learn/ai-agent-apps/agentic-patterns/chaining-and-routing",
  "/learn/ai-agent-apps/agentic-patterns/parallelization-and-orchestrator-workers",
  "/learn/ai-agent-apps/agentic-patterns/evaluator-optimizer",
  "/learn/ai-agent-apps/agentic-patterns/autonomous-agents",
  "/learn/ai-agent-apps/agentic-patterns/combining-patterns",
  "/learn/ai-agent-apps/production/agents-in-practice",
  "/learn/ai-agent-apps/production/tool-prompt-engineering",
  "/learn/ai-agent-apps/production/production-readiness-checklist",
  // C++ 并发编程实战（第2版）
