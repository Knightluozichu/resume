 ...
 *
 * 章节树由 content.getChapterTree() 在 Server 端生成（HEL-48，按 BOOK_ORDER 分书、
 * 书内按 SECTION_ORDER 分组、组内按 order、开发期含草稿）；桌面侧栏与移动抽屉复用
 * 同一棵树（同源）。当前书展开 + 当前章高亮在 ChapterNav（client，usePathname）内完成。
 *
