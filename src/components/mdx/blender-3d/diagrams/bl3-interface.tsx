/**
 * <Bl3InterfaceDiagram>：Blender 界面与导航图解。
...
export function Bl3InterfaceDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="Blender 界面与导航图解"
          className="mx-auto block h-auto w-full max-w-[720px]"
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">Blender 界面与导航</text>
          <rect x="70" y="80" width="130" height="50" rx="8" fill="var(--success)" fillOpacity="0.12" stroke="var(--success)" strokeWidth="1.2" />
          <text x="135" y="110" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--success)">视口</text>
          ...
          <text x="290" y="110" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--accent)">属性</text>
          ...
          <text x="445" y="110" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--warning)">大纲</text>
          ...
          <text x="600" y="110" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--text-tertiary)">着色器</text>
