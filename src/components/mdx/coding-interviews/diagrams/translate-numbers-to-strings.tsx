...
export function TranslateNumbersToStringsDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="flex justify-center">
        <svg viewBox="0 0 400 150" className="w-full max-w-[400px] h-auto">
          <text x="200" y="50" textAnchor="middle" fontSize="14" fontWeight="700" fill="var(--text-primary)">TranslateNumbersToStrings</text>
