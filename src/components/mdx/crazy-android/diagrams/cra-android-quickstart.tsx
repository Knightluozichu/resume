    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="185" y="102" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">用户App / 系统App（电话/短信/浏览器）</text>
          <text x="185" y="114" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Java/Kotlin编写，调用框架层API</text>
          ...
          <text x="185" y="166" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">ActivityManager / WindowManager</text>
          <text x="185" y="178" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">ContentProvider / View System / Notification</text>
          ...
          <text x="185" y="230" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">SQLite / OpenGL ES / WebKit / Media</text>
          <text x="185" y="242" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Dalvik/ART虚拟机 / 核心库</text>
          ...
          <text x="185" y="294" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">驱动 / 进程管理 / 电源管理</text>
          <text x="185" y="306" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Display / Camera / Binder IPC</text>
          ...
          <text x="110" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">AS向导/Gradle</text>
          ...
          <text x="255" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">XML布局+控件</text>
          ...
          <text x="400" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Activity/事件</text>
          ...
          <text x="545" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">清单文件声明</text>
          ...
          <text x="660" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">模拟器/真机</text>
          ...
          <text x="70" y="478" fontSize="11" fontFamily="monospace" fill="var(--text-secondary)">Log.v(tag, msg)  // VERBOSE 详细</text>
          <text x="70" y="494" fontSize="11" fontFamily="monospace" fill="var(--text-secondary)">Log.d(tag, msg)  // DEBUG 调试   Log.i(tag, msg) // INFO</text>
          <text x="400" y="478" fontSize="11" fontFamily="monospace" fill="var(--text-secondary)">Log.w(tag, msg)  // WARN 警告</text>
          <text x="400" y="494" fontSize="11" fontFamily="monospace" fill="var(--danger)">Log.e(tag, msg)  // ERROR 错误</text>

          <text x="70" y="530" fontSize="11" fill="var(--text-secondary)">DDMS = Dalvik Debug Monitor Service，提供线程/堆/文件浏览等调试视图</text>
        </svg>
      </div>
