    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第1章 系统架构/项目结构</text>
          <text x="535" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">清单文件/Gradle/调试</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第2章 六大布局/常用控件</text>
          <text x="205" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">AdapterView/列表视图</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第3章 监听/回调/触摸</text>
          <text x="535" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">按键事件/手势检测</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第4章 对话框/菜单/通知</text>
          <text x="205" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">ActionBar/滚动视图</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第5章 IO/SharedPreferences</text>
          <text x="535" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">SQLite/ContentProvider</text>
          ...
          <text x="205" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">广播机制/电话短信</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第7章 音视频/2D绘图</text>
          <text x="535" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">动画/传感器</text>
          ...
          <text x="205" y="480" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第8章 WebView/HTTP</text>
          <text x="205" y="492" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Socket/XML与JSON解析</text>
          ...
          <text x="535" y="492" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">四大组件→持久化→多媒体→网络</text>
        </svg>
      </div>
