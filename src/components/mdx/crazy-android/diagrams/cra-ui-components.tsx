    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="65" y="98" fontSize="9" fill="var(--text-secondary)">线性排列 orientation: horizontal/vertical + weight权重</text>
          ...
          <text x="65" y="148" fontSize="9" fill="var(--text-secondary)">相对定位 above/below/toLeftOf/toRightOf/alignParentX</text>
          ...
          <text x="65" y="198" fontSize="9" fill="var(--text-secondary)">表格 TableRow行 + collapseColumns/shrinkColumns/stretchColumns</text>
          ...
          <text x="65" y="248" fontSize="9" fill="var(--text-secondary)">层叠堆放 layout_gravity定位，Fragment容器首选</text>
          ...
          <text x="65" y="298" fontSize="9" fill="var(--text-secondary)">网格 rowCount/columnCount + layout_columnSpan跨列</text>
          ...
          <text x="65" y="348" fontSize="9" fill="var(--text-secondary)">绝对坐标 x/y（已废弃，不推荐使用）</text>
          ...
          <text x="435" y="102" fontSize="10" fill="var(--text-secondary)">TextView — 文本显示</text>
          <text x="435" y="118" fontSize="10" fill="var(--text-secondary)">EditText — 可编辑输入框</text>
          <text x="435" y="134" fontSize="10" fill="var(--text-secondary)">AutoCompleteTextView — 自动补全</text>
          <text x="435" y="150" fontSize="11" fontWeight="600" fill="var(--accent)">按钮类</text>
          <text x="435" y="168" fontSize="10" fill="var(--text-secondary)">Button / ImageButton / ToggleButton</text>
          <text x="435" y="184" fontSize="10" fill="var(--text-secondary)">CheckBox / RadioButton / Switch</text>
          ...
          <text x="435" y="234" fontSize="10" fill="var(--text-secondary)">ImageView — 图片显示</text>
          <text x="435" y="250" fontSize="10" fill="var(--text-secondary)">ProgressBar — 进度条（圆/横）</text>
          <text x="435" y="266" fontSize="10" fill="var(--text-secondary)">SeekBar — 可拖拽进度条</text>
          <text x="435" y="282" fontSize="10" fill="var(--text-secondary)">RatingBar — 评分条</text>
          ...
          <text x="435" y="342" fontSize="10" fill="var(--text-secondary)">ListView / GridView / Spinner</text>
          <text x="435" y="358" fontSize="10" fill="var(--text-secondary)">Gallery / AdapterViewFlipper</text>
          ...
          <text x="140" y="456" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">List&lt;Map&gt; / 数组</text>
          <text x="140" y="468" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">Cursor / JSON</text>
          ...
          <text x="350" y="456" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">ArrayAdapter</text>
          <text x="350" y="468" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">SimpleAdapter / BaseAdapter</text>
          ...
          <text x="580" y="456" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">ListView / GridView</text>
          <text x="580" y="468" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">getView() 创建/复用item视图</text>
          ...
          <text x="370" y="532" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">getView() 负责把数据项渲染为列表项View，View复用机制决定性能</text>
        </svg>
      </div>
