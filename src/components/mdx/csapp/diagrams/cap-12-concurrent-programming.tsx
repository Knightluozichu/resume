...
export function Cap12ConcurrentProgrammingMapLab() {
  return <OfficialCsappLab {...common} view="map" />;
}

export function Cap12ConcurrentProgrammingExperimentLab() {
  return <OfficialCsappLab {...common} view="experiment" />;
}

export function Cap12ConcurrentProgrammingEvidenceLab() {
