...
const nodes = [
  {
    ...
    stage: "锁定历史基线",
    mechanism:
      "卷I 第1章 阅读前的准备工作在“用同一启动、Binder、音频、窗口与输入案例跨越2.2、4.0.1和4.2.2完成证据交接”中的责任要翻译成一个可推翻的运行合同：明确入口、线程或进程、状态拥有者、正常结果和首个错误返回，再由版本差异表、调用图、进程线程、对象所有权、失败样本、现代迁移与回退演练复核。",
    probe:
  ...
  },
  {
    ...
    stage: "复现正常轨迹",
    mechanism:
      "卷I 第2章 深入理解JNI在“用同一启动、Binder、音频、窗口与输入案例跨越2.2、4.0.1和4.2.2完成证据交接”中的责任要翻译成一个可推翻的运行合同：明确入口、线程或进程、状态拥有者、正常结果和首个错误返回，再由版本差异表、调用图、进程线程、对象所有权、失败样本、现代迁移与回退演练复核。",
    probe:
  ...
  },
  {
    ...
    stage: "恢复同输入重放",
    mechanism:
      "卷I 第5章 深入理解常见类在“用同一启动、Binder、音频、窗口与输入案例跨越2.2、4.0.1和4.2.2完成证据交接”中的责任要翻译成一个可推翻的运行合同：明确入口、线程或进程、状态拥有者、正常结果和首个错误返回，再由版本差异表、调用图、进程线程、对象所有权、失败样本、现代迁移与回退演练复核。",
    probe:
  ...
  },
  {
    ...
    stage: "注入单一故障",
    mechanism:
      "卷III 第5章 深入理解Android输入系统在“用同一启动、Binder、音频、窗口与输入案例跨越2.2、4.0.1和4.2.2完成证据交接”中的责任要翻译成一个可推翻的运行合同：明确入口、线程或进程、状态拥有者、正常结果和首个错误返回，再由版本差异表、调用图、进程线程、对象所有权、失败样本、现代迁移与回退演练复核。",
    probe:
