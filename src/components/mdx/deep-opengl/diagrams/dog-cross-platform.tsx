    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox="0 0 720 400" role="img" aria-label="跨平台特性检测与降级路径" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <text x="56" y="184" fontSize="9.5" fill="var(--text-primary)">WebGL2 + color-buffer 探针</text>
          <text x="56" y="202" fontSize="9.5" fill="var(--text-secondary)">实例化 · UBO · HDR</text>
          <text x="56" y="220" fontSize="9.5" fill="var(--text-secondary)">浮点混合另行检测</text>
          ...
          <text x="496" y="184" fontSize="9.5" fill="var(--text-primary)">独立 WebGL1 后端</text>
          <text x="496" y="202" fontSize="9.5" fill="var(--text-secondary)">ES100 shader + 扩展适配</text>
          <text x="496" y="220" fontSize="9.5" fill="var(--text-secondary)">缺能力时选择替代算法</text>
