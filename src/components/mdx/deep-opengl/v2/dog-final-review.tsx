...
const unitTitle = "深入理解 OpenGL WebGL OpenGL ES 总复习";
const nodes = [
  {
    label: "context",
...
const model = {
  ...
  invariant:
    "深入理解 OpenGL WebGL OpenGL ES 总复习的输入、状态、输出与恢复结果可用同一证据包重放",
  fault:
...
export function DogFinalReviewStateLab() {
  return <OfficialGlStateLab mode="state" {...props} />;
}

export function DogFinalReviewFaultLab() {
  return <OfficialGlStateLab mode="fault" {...props} />;
}

export function DogFinalReviewEvidenceLab() {
