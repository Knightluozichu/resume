    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="137" y="100" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">标记存活 → 清除死亡</text>
          <text x="137" y="116" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">缺点：内存碎片</text>
          <text x="137" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">效率不稳定</text>
          <text x="137" y="148" textAnchor="middle" fontSize="11" fill="var(--danger)">适合老年代</text>
          ...
          <text x="369" y="100" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">存活对象复制到另一半</text>
          <text x="369" y="116" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">无碎片，简单高效</text>
          <text x="369" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">缺点：浪费一半空间</text>
          <text x="369" y="148" textAnchor="middle" fontSize="11" fill="var(--danger)">适合新生代</text>
          ...
          <text x="601" y="100" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">标记存活 → 整理到一端</text>
          <text x="601" y="116" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">无碎片，不浪费空间</text>
          <text x="601" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">缺点：移动开销大</text>
          <text x="601" y="148" textAnchor="middle" fontSize="11" fill="var(--danger)">适合老年代</text>
          ...
          <text x="220" y="232" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Eden:S0:S1 = 8:1:1</text>
          <text x="520" y="214" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--accent)">老年代（标记-清除/整理）</text>
          <text x="520" y="232" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">存活率高，移动少</text>
          ...
          <text x="100" y="318" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">单线程，STW</text>
          <text x="100" y="332" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">客户端模式</text>
          ...
          <text x="255" y="318" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">多线程并行，STW</text>
          <text x="255" y="332" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">吞吐量优先</text>
          ...
          <text x="410" y="318" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">并发标记-清除</text>
          <text x="410" y="332" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">低停顿优先</text>
          ...
          <text x="565" y="318" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Region 化分代</text>
          <text x="565" y="332" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">可预测停顿</text>
          ...
          <text x="680" y="318" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">染色指针</text>
          <text x="680" y="332" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">&lt;10ms</text>
          ...
          <text x="120" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">虚拟机栈中引用的对象</text>
          <text x="280" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">方法区静态属性引用</text>
          <text x="440" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">方法区常量引用</text>
          <text x="600" y="404" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">本地方法栈 JNI 引用</text>
          <text x="120" y="424" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">同步锁持有的对象</text>
          <text x="280" y="424" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">JVM 内部引用</text>
          <text x="440" y="424" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">JMXBean 等</text>
          <text x="600" y="424" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">跨代引用</text>
          <text x={VIEW_W / 2} y="450" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">从 GC Roots 不可达 = 可回收对象</text>
        </svg>
      </div>
