    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="205" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">五大部分递进结构</text>
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第1章 程序计数器/栈/堆/方法区</text>
          <text x="535" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">对象布局/OOM类型</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第2章 GC Roots/可达性分析</text>
          <text x="205" y="222" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">分代收集/收集器演进</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第3章 加载/验证/准备/解析/初始化</text>
          <text x="535" y="222" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">双亲委派/类加载器层次</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第4章 解释器/JIT/栈帧</text>
          <text x="205" y="312" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">字节码执行/方法调用</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第5章 分层编译/方法内联</text>
          <text x="535" y="312" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">逃逸分析/标量替换</text>
          ...
          <text x="205" y="390" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第6章 主内存/工作内存</text>
          <text x="205" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">happens-before/volatile</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第7章 偏向锁/轻量级锁/重量级锁</text>
          <text x="535" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">锁升级/自旋锁</text>
          ...
          <text x="370" y="480" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第8章 实战调优 + 第9章 全书复习——JVM核心技术体系整合</text>
          <text x="370" y="492" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">自动内存管理 / 虚拟机执行 / 并发体系 完整闭环</text>
        </svg>
      </div>
