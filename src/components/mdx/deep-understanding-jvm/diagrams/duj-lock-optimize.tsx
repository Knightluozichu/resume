    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="130" y="90" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Mark Word 记录线程 ID</text>
          <text x="130" y="106" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">无竞争：单线程独占</text>
          <text x="130" y="122" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">CAS 都不需要</text>
          <text x="130" y="140" textAnchor="middle" fontSize="11" fill="var(--danger)">JDK 15 后逐步废弃</text>

          <text x="245" y="110" textAnchor="middle" fontSize="16" fill="var(--text-tertiary)">&rarr;</text>
          <text x="245" y="128" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">竞争出现</text>
          ...
          <text x="370" y="90" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">CAS 自旋获取</text>
          <text x="370" y="106" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Mark Word 指向栈帧锁记录</text>
          <text x="370" y="122" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">适合短时间竞争</text>
          <text x="370" y="140" textAnchor="middle" fontSize="11" fill="var(--danger)">自旋消耗 CPU</text>

          <text x="485" y="110" textAnchor="middle" fontSize="16" fill="var(--text-tertiary)">&rarr;</text>
          <text x="485" y="128" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">自旋失败</text>
          ...
          <text x="610" y="90" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">OS 互斥量（Mutex）</text>
          <text x="610" y="106" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">线程进入内核态阻塞</text>
          <text x="610" y="122" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Monitor ObjectWaiter 队列</text>
          <text x="610" y="140" textAnchor="middle" fontSize="11" fill="var(--danger)">上下文切换开销大</text>
          ...
          <text x="60" y="222" fontSize="11" fill="var(--success)">无锁</text>
          <text x="190" y="222" fontSize="11" fill="var(--text-secondary)">hashCode(31) + age(4) + 0(1) + 01(2)</text>
          ...
          <text x="60" y="256" fontSize="11" fill="var(--success)">偏向锁</text>
          <text x="190" y="256" fontSize="11" fill="var(--text-secondary)">threadId(54) + epoch(2) + age(4) + 1(1) + 01(2)</text>
          ...
          <text x="60" y="290" fontSize="11" fill="var(--warning)">轻量级锁</text>
          <text x="190" y="290" fontSize="11" fill="var(--text-secondary)">指向栈中锁记录指针(62) + 00(2)</text>
          ...
          <text x="60" y="324" fontSize="11" fill="var(--danger)">重量级锁</text>
          <text x="190" y="324" fontSize="11" fill="var(--text-secondary)">指向 Monitor 对象指针(62) + 10(2)</text>
          ...
          <text x="60" y="358" fontSize="11" fill="var(--accent)">GC 标记</text>
          <text x="190" y="358" fontSize="11" fill="var(--text-secondary)">空(62) + 11(2)</text>
          ...
          <text x="137" y="430" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--warning)">自旋锁 / 适应性自旋</text>

          <rect x="262" y="406" width="215" height="40" rx="6" fill="var(--success)" fillOpacity="0.08" stroke="var(--success)" strokeWidth="1" />
          <text x="369" y="430" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--success)">锁消除（逃逸分析）</text>

          <rect x="494" y="406" width="215" height="40" rx="6" fill="var(--danger)" fillOpacity="0.08" stroke="var(--danger)" strokeWidth="1" />
          <text x="601" y="430" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--danger)">锁粗化（合并相邻同步块）</text>
        </svg>
      </div>
