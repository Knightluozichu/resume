    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="130" y="106" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">共享变量 A</text>

          <rect x="50" y="128" width="160" height="36" rx="4" fill="var(--accent)" fillOpacity="0.10" stroke="var(--accent)" strokeWidth="1" />
          <text x="130" y="150" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">共享变量 B</text>

          <rect x="50" y="172" width="160" height="36" rx="4" fill="var(--accent)" fillOpacity="0.10" stroke="var(--accent)" strokeWidth="1" />
          <text x="130" y="194" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">共享变量 C</text>

          <text x="130" y="222" textAnchor="middle" fontSize="10" fill="var(--text-tertiary)">所有线程共享</text>
          ...
          <text x="380" y="106" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">A 的副本</text>

          <rect x="300" y="128" width="160" height="36" rx="4" fill="var(--warning)" fillOpacity="0.10" stroke="var(--warning)" strokeWidth="1" />
          <text x="380" y="150" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">B 的副本</text>

          <rect x="300" y="172" width="160" height="36" rx="4" fill="var(--warning)" fillOpacity="0.10" stroke="var(--warning)" strokeWidth="1" />
          <text x="380" y="194" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">执行引擎</text>

          <text x="380" y="222" textAnchor="middle" fontSize="10" fill="var(--text-tertiary)">线程私有缓存</text>
          ...
          <text x="620" y="106" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">A 的副本</text>

          <rect x="550" y="128" width="140" height="36" rx="4" fill="var(--success)" fillOpacity="0.10" stroke="var(--success)" strokeWidth="1" />
          <text x="620" y="150" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">B 的副本</text>

          <rect x="550" y="172" width="140" height="36" rx="4" fill="var(--success)" fillOpacity="0.10" stroke="var(--success)" strokeWidth="1" />
          <text x="620" y="194" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">执行引擎</text>

          <text x="620" y="222" textAnchor="middle" fontSize="10" fill="var(--text-tertiary)">线程私有缓存</text>

          {/* 数据流箭头 */}
          <text x="245" y="140" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">read</text>
          <text x="245" y="155" textAnchor="middle" fontSize="14" fill="var(--text-tertiary)">&harr;</text>
          <text x="245" y="170" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">write</text>

          <text x="500" y="140" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">read</text>
          <text x="500" y="155" textAnchor="middle" fontSize="14" fill="var(--text-tertiary)">&harr;</text>
          <text x="500" y="170" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">write</text>

          {/* happens-before */}
          <text x={VIEW_W / 2} y="262" textAnchor="middle" fontSize="14" fontWeight="600" fill="var(--accent)">happens-before 八大规则</text>
          <text x={VIEW_W / 2} y="280" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">前一个操作的结果对后一个操作可见，且前一个操作排在后一个操作之前</text>

          <rect x="30" y="292" width="215" height="40" rx="6" fill="var(--warning)" fillOpacity="0.08" stroke="var(--warning)" strokeWidth="1" />
          <text x="137" y="316" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--warning)">1. 程序顺序规则</text>

          <rect x="262" y="292" width="215" height="40" rx="6" fill="var(--warning)" fillOpacity="0.08" stroke="var(--warning)" strokeWidth="1" />
          <text x="369" y="316" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--warning)">2. volatile 变量规则</text>

          <rect x="494" y="292" width="215" height="40" rx="6" fill="var(--warning)" fillOpacity="0.08" stroke="var(--warning)" strokeWidth="1" />
          <text x="601" y="316" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--warning)">3. 锁规则（monitor）</text>

          <rect x="30" y="342" width="215" height="40" rx="6" fill="var(--accent)" fillOpacity="0.08" stroke="var(--accent)" strokeWidth="1" />
          <text x="137" y="366" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--accent)">4. 线程启动规则</text>

          <rect x="262" y="342" width="215" height="40" rx="6" fill="var(--accent)" fillOpacity="0.08" stroke="var(--accent)" strokeWidth="1" />
          <text x="369" y="366" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--accent)">5. 线程终止规则</text>

          <rect x="494" y="342" width="215" height="40" rx="6" fill="var(--accent)" fillOpacity="0.08" stroke="var(--accent)" strokeWidth="1" />
          <text x="601" y="366" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--accent)">6. 线程中断规则</text>

          <rect x="120" y="392" width="215" height="40" rx="6" fill="var(--danger)" fillOpacity="0.08" stroke="var(--danger)" strokeWidth="1" />
          <text x="227" y="416" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--danger)">7. 对象终结规则</text>

          <rect x="395" y="392" width="215" height="40" rx="6" fill="var(--danger)" fillOpacity="0.08" stroke="var(--danger)" strokeWidth="1" />
          <text x="502" y="416" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--danger)">8. 传递性</text>
          ...
          <text x="370" y="464" textAnchor="middle" fontSize="10" fill="var(--success)">volatile：写操作 happens-before 读操作；禁止指令重排序；内存屏障保证可见性</text>
        </svg>
      </div>
