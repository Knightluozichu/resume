...
export function AccessInheritanceTable() {
  ...
  const rows = [
    {
      label: "public",
      colors: [good, good, secondary],
      access: ["public", "protected", "inaccessible"],
    },
    {
      label: "protected",
      colors: [warn, warn, secondary],
      access: ["protected", "protected", "inaccessible"],
    },
    {
      label: "private",
      colors: [danger, danger, secondary],
      access: ["private", "private", "inaccessible"],
    },
  ];
  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-x-auto overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text
            ...
            textAnchor="middle"
          >
            Base private members are NEVER directly accessible to derived
            classes
          </text>
            ...
            return (
              <g key={`row-${ri}`}>
                <rect
                  x={colX[0]}
                  y={y}
                  width={colX[3] + colW[3] - colX[0]}
                  height={rowH}
                  rx={4}
                  fill={ri % 2 === 0 ? elevated : bg}
                  stroke={border}
                  strokeWidth={0.5}
                />
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        <strong>public inheritance</strong> preserves access levels - IS-A
        relationship, most common.
        <strong>protected/private inheritance</strong> reduces visibility. Base{" "}
        <code>private</code> members are never directly accessible to derived
        classes regardless of inheritance type.
      </figcaption>
    </figure>
  );
}
