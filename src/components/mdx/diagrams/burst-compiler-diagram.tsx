    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text x="116" y="68" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
            C# 代码
          </text>
          <text x="116" y="82" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            带 [BurstCompile]
          </text>
          ...
          <text x="272" y="68" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
            IL → LLVM
          </text>
          <text x="272" y="82" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            调用 Burst 工具链
          </text>
          ...
          <text x="428" y="68" textAnchor="middle" fontSize="11" fill="var(--accent)">
            SIMD 原生码
          </text>
          <text x="428" y="82" textAnchor="middle" fontSize="11" fill="var(--accent)">
            向量化 · 内联
          </text>
          ...
          <text x="164" y="158" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--danger)">
            无 Burst（Mono/IL2CPP JIT）
          </text>
          <rect x="40" y="164" width="248" height="52" rx="4" fill="var(--bg-elevated)" stroke="var(--border)" />
          <text x="52" y="180" fontSize="11" fill="var(--text-secondary)" fontFamily="monospace">
            float3 a, b, c;
          </text>
          <text x="52" y="194" fontSize="11" fill="var(--text-secondary)" fontFamily="monospace">
            c.x = a.x + b.x;
          </text>
          <text x="52" y="208" fontSize="11" fill="var(--text-secondary)" fontFamily="monospace">
            c.y = a.y + b.y; c.z = a.z + b.z;
          </text>

          {/* With Burst */}
          <rect x="336" y="140" width="280" height="90" rx="8" fill="var(--bg)" stroke="var(--success)" strokeWidth="1.5" />
          <text x="476" y="158" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--success)">
            Burst 编译后（同一段 C#）
          </text>
          <rect x="352" y="164" width="248" height="52" rx="4" fill="var(--bg-elevated)" stroke="var(--success)" strokeWidth="1" />
          <text x="364" y="180" fontSize="11" fill="var(--success)" fontFamily="monospace">
            → SSE/NEON SIMD 指令
          </text>
          <text x="364" y="194" fontSize="11" fill="var(--success)" fontFamily="monospace">
            → addps (4 个 float 一次算)
          </text>
          <text x="364" y="208" fontSize="11" fill="var(--success)" fontFamily="monospace">
            → 循环展开 · 常量折叠 · 内联
          </text>
          ...
          <text x="80" y="296" textAnchor="middle" fontSize="11" fill="var(--danger)">
            Mono
          </text>
          <text x="80" y="308" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            1.0×
          </text>

          {/* IL2CPP */}
          <rect x="190" y="268" width="140" height="16" rx="3" fill="var(--warning)" opacity="0.5" />
          <text x="260" y="296" textAnchor="middle" fontSize="11" fill="var(--warning)">
            IL2CPP (AOT)
          </text>
          <text x="260" y="308" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            ~1.5–2×
          </text>

          {/* Burst */}
          <rect x="360" y="268" width="200" height="16" rx="3" fill="var(--success)" opacity="0.6" />
          <text x="460" y="296" textAnchor="middle" fontSize="11" fill="var(--success)">
            Burst (LLVM)
          </text>
          <text x="460" y="308" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--success)">
            10–100×
          </text>
        </svg>
      </div>
