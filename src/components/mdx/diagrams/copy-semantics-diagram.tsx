  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-x-auto overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <g transform="translate(12, 36)">
            ...
            {/* 两个指针指向同一块 */}
            <path
              d="M 180 90 L 226 110"
              stroke={accent}
              strokeWidth={1.5}
              markerEnd="url(#csAccentArr)"
            />
            <path
              d="M 180 210 L 226 155"
              stroke={danger}
              strokeWidth={1.5}
              markerEnd="url(#csDangerArr)"
            />
          ...
          <g transform="translate(396, 36)">
            ...
            {/* 指针分别指向各自堆 */}
            <path
              d="M 180 90 L 216 100"
              stroke={accent}
              strokeWidth={1.5}
              markerEnd="url(#csAccentArr)"
            />
            <path
              d="M 180 210 L 216 220"
              stroke={good}
              strokeWidth={1.5}
              markerEnd="url(#csGoodArr)"
            />
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        <strong>左侧（浅拷贝）</strong>
        ：编译器合成的拷贝只复制指针值——两个对象共享堆数据，修改一个影响另一个，析构时双重释放。
        <strong>右侧（深拷贝）</strong>
        ：自定义拷贝构造为每个对象分配独立堆内存并复制数据——各自独立，安全地分别析构。
      </figcaption>
    </figure>
  );
}
