        ...
        >
          ...
          <g transform="translate(14, 34)">
            ...
            <g transform="translate(12, 44)">
              <text x={0} y={0} fontSize={11} fontWeight={600} fill={primary}>
                ① 分配
              </text>
              <rect
                x={0}
            ...
            <g transform="translate(12, 214)">
              <text x={0} y={0} fontSize={11} fontWeight={600} fill={good}>
                ③ 释放
              </text>
              <rect
                x={0}
            ...
            <g transform="translate(12, 276)">
              <text x={0} y={0} fontSize={11} fontWeight={600} fill={danger}>
                ✕ 忘记 delete[]
              </text>
              <rect
                x={0}
          ...
          <text
            ...
            textAnchor="middle"
          >
            优先使用 vector（或 array）代替 new[]——它能自动释放、支持范围
            for、push_back 自动扩容，且异常安全
          </text>
        </svg>
      </div>
      <figcaption className="mt-2 text-center text-xs text-secondary">
        <strong>new[] 方案</strong>：手动分配，手动释放；忘记{" "}
        <code>delete[]</code>（提前 return / 抛异常）→ 内存泄漏。
        <strong>vector 方案</strong>：自动管理堆数组，RAII 保证离开作用域时自动{" "}
        <code>delete[]</code>；支持 <code>push_back</code> 自动扩容、范围 for
        遍历；异常安全。
      </figcaption>
    </figure>
  );
