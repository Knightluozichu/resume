  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-x-auto overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text
            ...
            textAnchor="middle"
          >
            protected 成员可被派生类访问但对用户不可见；virtual
            函数支持覆盖（override）
          </text>
          ...
          <polygon
            points="360,222 348,254 372,254"
            fill={bg}
            stroke={border}
            strokeWidth={1.5}
          />
          ...
          <text
            ...
            textAnchor="middle"
          >
            Inherited from base: bookNo (not directly accessible, private)
          </text>
          <text
            x={360}
            y={444}
            ...
            textAnchor="middle"
          >
            Inherited from base: isbn() (public, directly usable) / net_price
            (overridden)
          </text>
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        Base class <code>Quote</code> defines <code>bookNo</code>/
        <code>price</code> (private) and virtual <code>net_price</code>{" "}
        (public). Derived <code>Bulk_quote</code> inherits via{" "}
        <code>public</code> all base members and <strong>overrides</strong>{" "}
        <code>net_price</code>. Base private members exist in the derived object
