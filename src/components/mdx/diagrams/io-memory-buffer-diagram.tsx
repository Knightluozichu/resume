  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text x="60" y="250" fontSize="11" fill={token.textSecondary}>
            缓冲 =
            程序和硬件之间的中转站。键盘逐字符送来，缓冲区攒够再一起处理，
          </text>
          ...
          <text x="60" y="348" fontSize="11" fill="rgb(229,181,103)">
            scanf
            只吃掉匹配内容——换行符等留在缓冲区，下次读取会意外读到&quot;剩菜&quot;。
          </text>
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        printf 和 scanf
        都不直接跟硬件打交道——它们通过缓冲区这个中转站来往于程序和设备之间。缓冲区的存在让输入输出高效有序，但也是
        C 初学者「输入被跳过」类 bug 的根源。
      </figcaption>
    </figure>
  );
}
