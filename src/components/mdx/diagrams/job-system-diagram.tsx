    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text x="96" y="88" textAnchor="middle" fontSize="11" fill="var(--accent)">
            struct MyJob : IJob
          </text>

          <rect x="164" y="72" width="120" height="24" rx="4" fill="var(--bg-elevated)" stroke="var(--border)" />
          <text x="224" y="88" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
            public float data;
          </text>

          {/* Execute */}
          <rect x="36" y="102" width="248" height="18" rx="3" fill="var(--bg-elevated)" stroke="var(--border)" />
          <text x="160" y="115" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            void Execute() {"{"} data *= 2; {"}"}
          </text>

          <text x="160" y="138" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
          ...
          <text x="160" y="174" textAnchor="middle" fontSize="11" fill="var(--accent)">
            Worker 1 → Execute()
          </text>
          ...
          <text x="426" y="88" textAnchor="middle" fontSize="11" fill="var(--success)">
            struct ParallelJob : IJobFor
          </text>

          <rect x="504" y="72" width="100" height="24" rx="4" fill="var(--bg-elevated)" stroke="var(--border)" />
          <text x="554" y="88" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
            NativeArray
          </text>

          {/* Execute */}
          <rect x="356" y="102" width="248" height="18" rx="3" fill="var(--bg-elevated)" stroke="var(--border)" />
          <text x="480" y="115" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            Execute(int i) {"{"} arr[i] *= 2; {"}"}
          </text>

          <text x="480" y="138" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
          ...
          <text x="140" y="238" textAnchor="middle" fontSize="11" fill="var(--warning)">
            NativeArray 追踪依赖
          </text>

          <rect x="240" y="228" width="160" height="14" rx="3" fill="var(--bg-elevated)" />
          <text x="320" y="238" textAnchor="middle" fontSize="11" fill="var(--danger)">
            同一容器同一时刻不能并行写
          </text>

          <rect x="420" y="228" width="160" height="14" rx="3" fill="var(--bg-elevated)" />
          <text x="500" y="238" textAnchor="middle" fontSize="11" fill="var(--accent)">
            编译期 / 运行时双重检查
          </text>
          ...
          {/* Bottom summary */}
          <text x="320" y="294" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
