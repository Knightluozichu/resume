  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
          ...
          <g transform="translate(440, 310)">
            ...
            <g transform="translate(0, 18)">
              ...
              <text
                ...
                fontFamily="monospace"
              >
                [](int a, int b) {"{ return a + b; }"} &#47;&#47; 显式 return
              </text>
              <text
                x="14"
                y="34"
                ...
                fontFamily="monospace"
              >
                [](int a, int b) {"{ return a + b; }"} &#47;&#47; C++11 必须
                return
              </text>
            </g>
          </g>
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        Lambda
        表达式由四部分构成：捕获列表（如何访问外部变量）、参数列表（与普通函数相同）、返回类型（可省略，自动推导）、函数体。编译器将其展开为匿名函数对象。
      </figcaption>
    </figure>
  );
}
