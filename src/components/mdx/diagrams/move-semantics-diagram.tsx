  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        <strong>Step 1</strong>：源持有资源，目标为空。<strong>Step 2</strong>
        ：执行 ptr 转移 + 源指针置空（O(1) 常数时间，无内存分配）。
        <strong>Step 3</strong>
        ：目标接管资源负责释放，源处于「有效但未指定」状态（可安全析构或重新赋值）。
      </figcaption>
    </figure>
  );
}
