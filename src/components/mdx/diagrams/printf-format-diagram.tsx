...
export function PrintfFormatDiagram() {
  const items: FormatItem[] = [
    {
      segment: '"num="',
      meaning: "普通文字：原样输出到屏幕",
      replacement: "—",
      output: "num=",
    },
    {
      segment: "%d",
      meaning: "转换说明：把 int 参数转成十进制整数字符串",
      replacement: "10",
      output: "10",
    },
    {
    ...
    {
      segment: "%.2f",
      meaning: "转换说明：把 float 参数转成小数，保留 2 位",
      replacement: "3.14",
      output: "3.14",
    },
    {
    ...
    {
      segment: "%s",
      meaning: "转换说明：把 char* 字符串参数填入",
      replacement: '"Tom"',
      output: "Tom",
    },
    {
      segment: "\\n",
      meaning: "转义序列：输出一个换行符",
      replacement: "—",
      output: "↲ 换行",
    },
  ];
      ...
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          {items.map((item, i) => {
            ...
            const isFormat =
              item.segment.startsWith("%") || item.segment === "\\n";
            const rowBg = i % 2 === 0 ? "var(--bg)" : "var(--bg-elevated)";
            const segmentColor = isFormat
              ? "var(--accent)"
              : "var(--text-primary)";
            ...
            return (
              <g key={i}>
                ...
                <text
                  ...
                  fontFamily={
                    item.replacement === "—" ? undefined : "monospace"
                  }
