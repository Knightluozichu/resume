  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
        ...
        >
          ...
          <g opacity={showInput ? 1 : 0.3}>
            ...
            <rect
              ...
              rx="6"
              fill={token.bg}
              stroke={step === 1 ? token.accent : token.border}
            ...
            <text
              ...
              y="75"
              fontSize="13"
              fill={step === 1 ? token.accent : token.textSecondary}
              textAnchor="middle"
              fontFamily="monospace"
            >
              {"42 3.14↵"}
            ...
            {showInput && (
              <>
                <rect
                  ...
                  rx="4"
                  fill={token.accent}
                  opacity={showMatch ? 0.18 : 0.25}
                  stroke={showMatch ? token.accent : token.border}
                  strokeWidth={showMatch ? "2" : "1"}
                />
                <text
                  x="81"
                  y="158"
                ...
                <rect
                  ...
                  fill="rgb(99,179,237)"
                  opacity={showMatch ? 0.18 : 0.25}
                  stroke={showMatch ? "rgb(99,179,237)" : token.border}
                  strokeWidth={showMatch ? "2" : "1"}
                />
                <text
                  x="213"
                ...
                <rect
                  ...
                  opacity={showAll ? 0.35 : 0.1}
                  stroke={showAll ? "rgb(229,181,103)" : token.border}
                  strokeWidth={showAll ? "2" : "1"}
                />
                <text
                  x="389"
                  y="158"
                  fontSize="12"
                  fontWeight="700"
                  fill={showAll ? "rgb(229,181,103)" : token.textSecondary}
                  textAnchor="middle"
                  fontFamily="monospace"
                >
                  ↵
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        {step === 1 &&
          "第一步：用户输入的内容先进入键盘缓冲区，scanf 从这里读而不是直接从键盘读。"}
        {step === 2 &&
          "第二步：scanf 按格式串从缓冲区匹配数据——%d 读整数、%f 读浮点数——用 & 取变量地址写入。"}
        {step === 3 &&
          "第三步：scanf 格式串之外未匹配的字符（如换行符 \\n）残留在缓冲区——下一次输入会被干扰，这是 C 初学者最容易遇到的\u201c输入失灵\u201dbug。"}
      </figcaption>
    </figure>
  );
}
