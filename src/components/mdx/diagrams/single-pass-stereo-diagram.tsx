    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text x="70" y="88" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
            场景网格
          </text>
          ...
          {isSingle ? (
            <>
              ...
              <text x="260" y="80" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--accent)">
                1× Draw + SV_InstanceID
              </text>
              <text x="260" y="98" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
              ...
              <text x="445" y="62" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
                左眼 RT
              </text>
              <rect x="400" y="88" width="90" height="36" rx="4" fill="var(--bg)" stroke="var(--border)" />
              <text x="445" y="110" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
                右眼 RT
              </text>
            </>
          ) : (
            <>
              ...
              <text x="230" y="76" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
                Pass 1 · 左眼
              </text>
              <rect x="170" y="100" width="120" height="40" rx="6" fill="var(--bg)" stroke="var(--danger)" strokeWidth="1.5" />
              <text x="230" y="124" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
                Pass 2 · 右眼
              </text>
              ...
              <text x="420" y="76" fontSize="11" fill="var(--danger)">
                CPU 提交 ×2
              </text>
              <text x="420" y="124" fontSize="11" fill="var(--danger)">
                SetPass ×2
              </text>
            </>
          )}
          ...
          <text x="36" y="162" fontSize="11" fontWeight="600" fill="var(--text-primary)">
            URP / Shader 要求
          </text>
          {isSingle ? (
            <>
              <text x="36" y="182" fontSize="11" fill="var(--text-secondary)">
                • 启用 XR Plug-in Management + URP Renderer「Single Pass Instanced」
              </text>
              <text x="36" y="198" fontSize="11" fill="var(--text-secondary)">
                • Shader 用 unity_StereoEyeIndex 选 MVP · 避免硬编码单眼矩阵
              </text>
              <text x="36" y="214" fontSize="11" fill="var(--text-secondary)">
            ...
            <>
              ...
              <text x="36" y="214" fontSize="11" fill="var(--danger)">
