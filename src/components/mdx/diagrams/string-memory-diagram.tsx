  ...
  return (
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-x-auto overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <rect
            ...
            opacity="0.08"
          />
          <text x="60" y="256" fontSize="11" fill="rgb(229,181,103)">
            ⚠ 大小固定，不能动态扩展
          </text>
          <text x="60" y="274" fontSize="11" fill="rgb(229,181,103)">
            ⚠ s = &quot;Hello World!&quot; 放不下
          </text>
          ...
          <rect
            ...
            opacity="0.08"
          />
          <text x="410" y="316" fontSize="11" fill="rgb(63,185,127)">
            ✓ 堆上分配，大小可动态增长
          </text>
          <text x="410" y="334" fontSize="11" fill="rgb(63,185,127)">
            ✓ s = &quot;Hello World!&quot; 完全没问题
          </text>
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        C
        风格数组（左）把字符连续排在栈上，大小写好就定死了。std::string（右）只在栈上存一根指针，实际数据躲在堆里——换一根更长的字符串，只要重新在堆上分配、把指针指过去就行，原来的栈上空间只占那三四个字段。
      </figcaption>
    </figure>
  );
}
