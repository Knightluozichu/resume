    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text x="160" y="86" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
            int x = 0
          </text>

          {/* Thread A */}
          <rect x="30" y="110" width="100" height="28" rx="4" fill="var(--bg-elevated)" stroke="var(--accent)" />
          <text x="80" y="128" textAnchor="middle" fontSize="11" fill="var(--accent)">
            线程 A：x++
          </text>

          {/* Thread B */}
          <rect x="190" y="110" width="100" height="28" rx="4" fill="var(--bg-elevated)" stroke="var(--danger)" />
          <text x="240" y="128" textAnchor="middle" fontSize="11" fill="var(--danger)">
            线程 B：x++
          </text>
          ...
          <text x="160" y="170" textAnchor="middle" fontSize="11" fill="var(--danger)">
          ...
          <text x="394" y="88" textAnchor="middle" fontSize="11" fill="var(--accent)">
            线程 A 持有锁
          </text>
          <rect x="438" y="74" width="80" height="20" rx="3" fill="var(--warning)" opacity="0.45" />
          <text x="478" y="88" textAnchor="middle" fontSize="11" fill="var(--warning)">
            线程 B 等待
          </text>
          <rect x="522" y="74" width="84" height="20" rx="3" fill="var(--accent)" opacity="0.35" />
          <text x="564" y="88" textAnchor="middle" fontSize="11" fill="var(--accent)">
            A 释放锁继续
          </text>
          ...
          <text x="480" y="140" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            正确但变串行——多核白买了
          </text>
          <text x="480" y="158" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            高频加锁 = 上下文切换 = CPU 空转
          </text>
          ...
          <text x="320" y="230" textAnchor="middle" fontSize="11" fill="var(--text-primary)">
            主线程：Update · LateUpdate · 渲染 · 物理 · 动画……全挤一条线
          </text>

          <text x="320" y="258" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            GameObject API 不是线程安全的 → 几乎不能从 Job 里直接操作
          </text>

          {/* Solution */}
          <text x="320" y="286" textAnchor="middle" fontSize="11" fill="var(--accent)">
