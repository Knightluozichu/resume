    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          <text x="160" y="66" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">每次换材质 → 重建管线状态</text>
          ...
          {/* SetPass label — positioned above the object rects to avoid overlap */}
          <text x="232" y="78" fontSize="11" fill="var(--text-secondary)" textAnchor="middle">SetPass ×3</text>

          {/* GPU side */}
          <rect x="60" y="120" width="180" height="50" rx="4" fill="var(--bg)" stroke="var(--border)" strokeWidth="1" />
          <text x="150" y="142" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">每次 SetPass：重建 CB 布局</text>
          <text x="150" y="158" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">绑纹理→设 RS→发 Draw</text>
          ...
          <text x="152" y="224" textAnchor="middle" fontSize="11" fill="var(--danger)">3× 管线配置 = 3× 开销</text>
          ...
          <text x="480" y="66" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">统一布局 · 只换参数不重建状态</text>
          ...
          <text x="480" y="142" textAnchor="middle" fontSize="11" fontFamily="monospace" fill="var(--accent)">1× SetPass · 3 物体合批</text>

          <rect x="380" y="166" width="200" height="40" rx="4" fill="var(--bg)" stroke="var(--success)" strokeWidth="1.5" />
          <text x="480" y="186" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">统一 CB 布局 · 只更新参数块</text>
          <text x="480" y="200" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">管线状态不动 → 少开销</text>

          <text x="480" y="232" textAnchor="middle" fontSize="11" fill="var(--success)">3x 物体 = 1x 管线配置</text>

          {/* Bottom annotation */}
          <text x="320" y="272" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
