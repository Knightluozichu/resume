    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-x-auto overflow-hidden rounded-card border border-border bg-elevated p-4">
        ...
        >
          ...
          >
            {step === 1 &&
              "Step 1: Each object with virtual functions has a hidden vptr pointing to its vtable"}
            {step === 2 &&
              "Step 2: The vtable is an array of function pointers - each virtual function occupies one slot"}
            {step === 3 &&
              "Step 3: At runtime, vptr → vtable → function pointer resolves which version to call"}
          </text>
          ...
          {step === 1 && (
            <>
              ...
              <text
                ...
                textAnchor="middle"
              >
                8 bytes (64-bit) vptr at obj start
              </text>
          ...
          {step === 3 && (
            <>
              ...
              <text
                ...
                textAnchor="middle"
              >
                item is const Quote& - compiler only knows base type
              </text>
              ...
              <text
                ...
                textAnchor="middle"
              >
                At runtime: item may actually reference a Bulk_quote object!
              </text>
              ...
              <text
                ...
                fontFamily="monospace"
              >
                item.net_price(n) -- compiler generates:
              </text>
              ...
              <text
                ...
                textAnchor="middle"
              >
                Compile time: only knows net_price is virtual; Runtime: resolves
                via vtable
              </text>
              <text
                x={360}
      ...
      <figcaption className="mt-2 text-center text-xs text-secondary">
        ...
        {step === 2 &&
          "The <strong>vtable</strong> is a function pointer array. Each virtual function occupies a fixed slot. Derived classes replace slot entries with their own versions."}
        {step === 3 &&
          "When calling through a base pointer/reference: compile-time static type is Base, but runtime <strong>dynamic dispatch</strong> follows vptr → vtable → function address to the correct version."}
      </figcaption>
    </figure>
  );
}
