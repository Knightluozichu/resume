    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x={138} y={112} textAnchor="middle" fontSize="11" fill={secondary}>分配原始内存</text>
          ...
          <text x={368} y={112} textAnchor="middle" fontSize="11" fill={secondary}>在内存上构造对象</text>
          ...
          <text x={588} y={112} textAnchor="middle" fontSize="11" fill={secondary}>T* p = new T</text>

          {/* 异常标注 */}
          <line x1={368} y1={128} x2={368} y2={148} stroke={warning} strokeWidth="1.4" strokeDasharray="3 2" markerEnd="url(#efc-nd-arrow-warn)" />
          <text x={368} y={164} textAnchor="middle" fontSize="11" fill={warning}>构造失败 → operator delete 自动回收内存</text>
          ...
          <text x={138} y={266} textAnchor="middle" fontSize="11" fill={secondary}>清理对象资源</text>
          ...
          <text x={368} y={266} textAnchor="middle" fontSize="11" fill={secondary}>释放原始内存</text>
          ...
          <text x={588} y={266} textAnchor="middle" fontSize="11" fill={secondary}>delete p</text>
          ...
          <text x={128} y={388} textAnchor="middle" fontSize="11" fill={secondary} fontFamily="monospace">char buf[sizeof(T)]</text>
          ...
          <text x={348} y={388} textAnchor="middle" fontSize="11" fill={secondary} fontFamily="monospace">new (buf) T()</text>
          ...
          <text x={578} y={388} textAnchor="middle" fontSize="11" fill={secondary}>不分配，只构造</text>
