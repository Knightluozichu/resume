    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x={108} y={110} textAnchor="middle" fontSize="11" fill={secondary}>分配 + 构造</text>
          ...
          <text x={288} y={110} textAnchor="middle" fontSize="11" fill={secondary}>业务逻辑</text>
          ...
          <text x={468} y={110} textAnchor="middle" fontSize="11" fill={secondary}>析构 + 释放</text>
          ...
          <text x={622} y={108} textAnchor="middle" fontSize="11" fill={secondary}>异常 / 提前 return</text>
          ...
          <text x={143} y={270} textAnchor="middle" fontSize="11" fill={secondary}>引用计数 → 0 时释放</text>
          <text x={143} y={288} textAnchor="middle" fontSize="11" fill={secondary}>可拷贝、可共享</text>
          <text x={143} y={306} textAnchor="middle" fontSize="11" fill={secondary}>线程安全计数</text>
          <text x={143} y={324} textAnchor="middle" fontSize="11" fill={secondary}>循环引用风险</text>
          ...
          <text x={360} y={270} textAnchor="middle" fontSize="11" fill={secondary}>同一时刻唯一持有</text>
          <text x={360} y={288} textAnchor="middle" fontSize="11" fill={secondary}>不可拷贝，可 move</text>
          <text x={360} y={306} textAnchor="middle" fontSize="11" fill={secondary}>零开销抽象</text>
          <text x={360} y={324} textAnchor="middle" fontSize="11" fill={secondary}>替代 auto_ptr</text>
          ...
          <text x={577} y={270} textAnchor="middle" fontSize="11" fill={secondary}>不增加引用计数</text>
          <text x={577} y={288} textAnchor="middle" fontSize="11" fill={secondary}>lock() 提升为 shared</text>
          <text x={577} y={306} textAnchor="middle" fontSize="11" fill={secondary}>打破循环引用</text>
          <text x={577} y={324} textAnchor="middle" fontSize="11" fill={secondary}>临时观察资源</text>
