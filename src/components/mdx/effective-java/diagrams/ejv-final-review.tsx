    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="140" y="118" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">静态工厂 / Builder / try-with-resources</text>
          ...
          <text x="600" y="118" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">equals / hashCode / toString / compareTo</text>
          ...
          <text x="140" y="198" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">组合优于继承 / 最小可访问性</text>
          ...
          <text x="600" y="198" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">PECS / 类型安全 / 无原生态类型</text>
          ...
          <text x="140" y="358" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">枚举单例 / EnumSet / 注解替代命名模式</text>
          ...
          <text x="600" y="358" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">方法引用 / 无副作用 / Stream管道</text>
          ...
          <text x="140" y="438" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">参数校验 / 防御性拷贝 / Optional</text>
          ...
          <text x="600" y="438" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">同步 / 线程池 / 并发集合 / 安全发布</text>
