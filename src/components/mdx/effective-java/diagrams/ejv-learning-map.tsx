    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="205" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第1章 静态工厂/Builder/try-with-resources</text>
          <text x="205" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">避免创建不必要的对象</text>
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第2章 equals/hashCode/toString</text>
          <text x="535" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">compareTo/clone 契约</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第3章 最小可访问性/组合优于继承</text>
          <text x="205" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">接口优于抽象类/标签类</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第4章 泛型类型/PECS通配符</text>
          <text x="535" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">类型安全/原生态类型危害</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第5章 枚举单例/EnumSet/注解</text>
          <text x="205" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">用实例域代替序数</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第6章 Lambda/方法引用/Stream</text>
          <text x="535" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">函数式接口/Collector</text>
          ...
          <text x="205" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第7章 参数校验/Optional</text>
          <text x="205" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">防御性拷贝/重载与覆写</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第8章 同步/线程池/并发集合</text>
          <text x="535" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">volatile/不可变/安全发布</text>
          ...
          <text x="370" y="480" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第9章 90条最佳实践整合——从对象创建到并发编程全链路</text>
          <text x="370" y="492" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">API设计 / 代码质量 / 并发安全 完整体系</text>
        </svg>
      </div>
