    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          {/* 回退路径标注 */}
          <text x="335" y="143" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">&larr; onRestart()</text>
          <text x="335" y="199" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">&larr; onResume()</text>
          ...
          <text x="555" y="150" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">replace() 替换Fragment</text>
          <text x="555" y="164" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">addToBackStack() 加入回退栈</text>
          ...
          <text x="555" y="218" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">onAttach → onCreate</text>
          <text x="555" y="232" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">onCreateView → onViewCreated</text>
          ...
          <text x="555" y="286" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Fragment比Activity多了</text>
          <text x="555" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">视图生命周期（view销毁≠fragment销毁）</text>
          ...
          <text x="490" y="382" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">指定目标类名</text>
          <text x="490" y="394" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Intent(this, B::class.java)</text>
          ...
          <text x="620" y="382" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">指定action/category</text>
          <text x="620" y="394" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">系统匹配IntentFilter</text>
          ...
          <text x="130" y="460" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">standard — 每次新建实例</text>
          <text x="130" y="474" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">入栈顶层</text>
          <text x="310" y="460" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">singleTop — 栈顶复用</text>
          <text x="310" y="474" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">栈顶已有则调onNewIntent</text>
          <text x="490" y="460" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">singleTask — 栈内单例</text>
          <text x="490" y="474" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">清空上方Activity</text>
          <text x="640" y="460" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">singleInstance</text>
          <text x="640" y="474" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">独立任务栈</text>
