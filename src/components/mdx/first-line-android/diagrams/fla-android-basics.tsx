    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="170" y="106" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">用户App：电话/短信/浏览器</text>
          ...
          <text x="170" y="166" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">ActivityManager/WindowManager/</text>
          <text x="170" y="178" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">ContentProvider/View System</text>
          ...
          <text x="170" y="226" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">SQLite/OpenGL/Media</text>
          <text x="170" y="238" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Dalvik/ART虚拟机</text>
          ...
          <text x="170" y="286" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">驱动/电源管理/进程管理</text>
          ...
          <text x="540" y="104" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">java/com/example/app/ — Kotlin/Java源码</text>
          <text x="540" y="116" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">AndroidManifest.xml — 清单文件</text>
          ...
          <text x="540" y="164" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">layout/ 布局XML</text>
          <text x="540" y="176" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">values/ 字符串/颜色/样式</text>
          ...
          <text x="540" y="224" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">dependencies 依赖管理</text>
          <text x="540" y="236" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">compileSdk / minSdk / targetSdk</text>
          ...
          <text x="540" y="284" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">gradlew / gradle-wrapper.properties</text>
          <text x="540" y="296" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">版本锁定，团队一致性</text>
          ...
          <text x="120" y="386" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Log.d() 调试日志</text>
          <text x="120" y="400" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Logcat 过滤查看</text>
          <text x="300" y="386" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">R.string.app_name</text>
          <text x="300" y="400" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">R.layout.activity_main</text>
          <text x="500" y="386" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">AndroidManifest</text>
          <text x="500" y="400" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">注册四大组件</text>
          <text x="650" y="386" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">ADB调试</text>
          <text x="650" y="400" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">adb install / adb shell</text>
