    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="370" y="304" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">需同时 stop + unbind 全部才销毁</text>
          ...
          <text x="135" y="386" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">NotificationChannel</text>
          <text x="135" y="400" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">channelId 重要性等级</text>
          <text x="135" y="414" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">必须创建才能显示通知</text>
          ...
          <text x="375" y="386" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">setContentTitle / setText</text>
          <text x="375" y="400" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">setSmallIcon（必须）</text>
          <text x="375" y="414" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">setPendingIntent 点击跳转</text>
          ...
          <text x="610" y="386" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">notify(id, notification)</text>
          <text x="610" y="400" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">前台服务必须显示通知</text>
          <text x="610" y="414" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">startForeground(id, notif)</text>

          {/* 底部：前台服务与后台限制 */}
          <text x="370" y="458" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--accent)">前台服务与后台限制</text>
          <text x="370" y="478" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">前台服务：用户可见的通知 + startForeground()，不易被系统杀死</text>
          <text x="370" y="494" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">后台Service：Android 8.0+ 后台运行受限，推荐使用 WorkManager 调度</text>
          <text x="370" y="510" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">onStartCommand 返回值：START_STICKY / START_NOT_STICKY / START_REDELIVER_INTENT</text>
        </svg>
      </div>
