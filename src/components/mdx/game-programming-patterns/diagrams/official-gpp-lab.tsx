...
export function GppPipelineLab({ title, focus, stages }: LabProps) {
...
export function GppBudgetLab({ title, focus, stages }: LabProps) {
...
export function GppEvidenceLab({ title, focus, stages }: LabProps) {
