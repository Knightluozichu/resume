    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="80" y="98" textAnchor="middle" fontSize="11" fill="var(--success)">mutator</text>
          <rect x="115" y="76" width="170" height="36" fill="var(--danger)" fillOpacity="0.3" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="200" y="98" textAnchor="middle" fontSize="11" fill="var(--danger)">STW GC（长停顿）</text>
          <rect x="290" y="76" width="30" height="36" fill="var(--success)" fillOpacity="0.2" stroke="var(--success)" strokeWidth="0.8" />
          <text x="305" y="98" textAnchor="middle" fontSize="11" fill="var(--success)">m</text>

          <text x="185" y="140" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">停顿时间长，吞吐好，延迟差</text>
          ...
          <text x="435" y="98" textAnchor="middle" fontSize="11" fill="var(--success)">m</text>
          <rect x="455" y="76" width="40" height="36" fill="var(--danger)" fillOpacity="0.4" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="475" y="98" textAnchor="middle" fontSize="11" fill="var(--danger)">初始STW</text>
          <rect x="500" y="76" width="100" height="36" fill="var(--accent)" fillOpacity="0.15" stroke="var(--accent)" strokeWidth="0.8" />
          <text x="550" y="92" textAnchor="middle" fontSize="11" fill="var(--accent)">并发标记</text>
          <text x="550" y="104" textAnchor="middle" fontSize="11" fill="var(--accent)">mutator+GC</text>
          <rect x="605" y="76" width="40" height="36" fill="var(--danger)" fillOpacity="0.4" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="625" y="98" textAnchor="middle" fontSize="11" fill="var(--danger)">再标记STW</text>
          <rect x="650" y="76" width="40" height="36" fill="var(--accent)" fillOpacity="0.15" stroke="var(--accent)" strokeWidth="0.8" />
          <text x="670" y="98" textAnchor="middle" fontSize="11" fill="var(--accent)">并发清除</text>

          <text x="555" y="140" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">停顿短，延迟好，需屏障开销</text>
          ...
          <text x="55" y="240" fontSize="11" fill="var(--text-secondary)">① 黑色B指向白色D（新引用）</text>
          <text x="55" y="254" fontSize="11" fill="var(--text-secondary)">② 灰色A→D的旧引用被删除</text>
          <text x="55" y="268" fontSize="11" fill="var(--text-secondary)">③ GC未看到B→D，D被误回收!</text>

          <circle cx="80" cy="292" r="8" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="1" />
          <text x="80" y="295" textAnchor="middle" fontSize="11" fill="var(--text-primary)">B</text>
          <text x="80" y="312" textAnchor="middle" fontSize="11" fill="var(--success)">黑</text>

          <text x="98" y="295" fontSize="11" fill="var(--danger)">{`--new-->`}</text>

          <circle cx="150" cy="292" r="8" fill="none" stroke="var(--text-secondary)" strokeWidth="1" />
          <text x="150" y="295" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">D</text>
          <text x="150" y="312" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">白</text>

          <text x="55" y="330" fontSize="11" fill="var(--danger)">D实际存活但被误回收 → 程序崩溃</text>
          ...
          <text x="395" y="240" fontSize="11" fill="var(--text-secondary)">① 对象已被标记为黑色（存活）</text>
          <text x="395" y="254" fontSize="11" fill="var(--text-secondary)">② mutator随后删除所有引用</text>
          <text x="395" y="268" fontSize="11" fill="var(--text-secondary)">③ GC本轮不会回收它</text>

          <circle cx="440" cy="292" r="8" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="1" />
          <text x="440" y="295" textAnchor="middle" fontSize="11" fill="var(--text-primary)">X</text>
          <text x="440" y="312" textAnchor="middle" fontSize="11" fill="var(--success)">黑</text>

          <text x="458" y="295" fontSize="11" fill="var(--warning)">{`--del--> 垃圾`}</text>

          <text x="395" y="330" fontSize="11" fill="var(--warning)">X实际已死但本轮不回收 → 下轮再说</text>
          ...
          <text x="55" y="416" fontSize="11" fill="var(--text-secondary)">开始时快照所有引用关系</text>
          <text x="55" y="430" fontSize="11" fill="var(--text-secondary)">写屏障拦截删除引用：</text>
          <text x="55" y="444" fontSize="11" fill="var(--accent)">{`  旧引用指向的白色对象 → 灰`}</text>
          <text x="55" y="458" fontSize="11" fill="var(--text-secondary)">保证不漏标（可能多标）</text>
          <text x="55" y="474" fontSize="11" fill="var(--text-tertiary)">G1/CMS 使用 SATB 或类似策略</text>
          ...
          <text x="395" y="416" fontSize="11" fill="var(--text-secondary)">只记录新增引用</text>
          <text x="395" y="430" fontSize="11" fill="var(--text-secondary)">写屏障拦截新增引用：</text>
          <text x="395" y="444" fontSize="11" fill="var(--success)">{`  黑→白的新引用 → 黑变灰`}</text>
          <text x="395" y="458" fontSize="11" fill="var(--text-secondary)">重新扫描灰色对象</text>
          <text x="395" y="474" fontSize="11" fill="var(--text-tertiary)">CMS/G1 使用 INC 或混合策略</text>
        </svg>
      </div>
