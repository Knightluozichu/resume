    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="370" y="136" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--accent)">GC核心</text>
          <text x="370" y="150" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">可达性分析</text>

          {/* 四大基础算法 */}
          <rect x="40" y="100" width="120" height="36" rx="6" fill="var(--warning)" fillOpacity="0.12" stroke="var(--warning)" strokeWidth="1" />
          <text x="100" y="122" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--warning)">标记-清除</text>

          <rect x="40" y="144" width="120" height="36" rx="6" fill="var(--danger)" fillOpacity="0.12" stroke="var(--danger)" strokeWidth="1" />
          <text x="100" y="166" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--danger)">复制式回收</text>

          <rect x="580" y="100" width="120" height="36" rx="6" fill="var(--success)" fillOpacity="0.12" stroke="var(--success)" strokeWidth="1" />
          <text x="640" y="122" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--success)">标记-压缩</text>
          ...
          <text x="640" y="166" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--text-primary)">分代回收</text>
          ...
          <text x="285" y="222" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--accent)">并发回收</text>

          <rect x="390" y="200" width="130" height="36" rx="6" fill="var(--accent)" fillOpacity="0.12" stroke="var(--accent)" strokeWidth="1" />
          <text x="455" y="222" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--accent)">实时GC</text>
          ...
          <text x="185" y="222" textAnchor="middle" fontSize="11" fill="var(--warning)">G1</text>

          <rect x="530" y="200" width="50" height="36" rx="4" fill="var(--success)" fillOpacity="0.08" stroke="var(--success)" strokeWidth="0.6" />
          <text x="555" y="222" textAnchor="middle" fontSize="11" fill="var(--success)">ZGC</text>
          ...
          <text x="90" y="306" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--text-primary)">场景</text>
          ...
          <text x="210" y="306" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--text-primary)">推荐算法</text>
          ...
          <text x="335" y="306" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--text-primary)">理由</text>
          ...
          <text x="90" y="444" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">嵌入式/受限</text>
          ...
          <text x="210" y="444" textAnchor="middle" fontSize="11" fill="var(--text-primary)">标记-清除</text>
          ...
          <text x="335" y="444" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">低开销+无移动</text>
          ...
          <text x="565" y="444" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Serial Mark-Sweep / 增量式</text>
          ...
          <text x="380" y="488" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--accent)">全书核心闭环</text>
          <text x="380" y="504" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">算法（标记/复制/压缩/分代）→ 性能（吞吐/延迟/内存）→ 工程（并发/实时/现代实现）</text>
        </svg>
      </div>
