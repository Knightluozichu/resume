    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="110" y="110" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--text-primary)">Eden</text>
          <text x="110" y="126" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">新对象分配区</text>

          <rect x="180" y="92" width="120" height="44" rx="4" fill="var(--warning)" fillOpacity="0.15" stroke="var(--warning)" strokeWidth="0.8" />
          <text x="240" y="110" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--text-primary)">Survivor 0</text>
          <text x="240" y="126" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">存活区1</text>

          <rect x="310" y="92" width="120" height="44" rx="4" fill="var(--warning)" fillOpacity="0.15" stroke="var(--warning)" strokeWidth="0.8" />
          <text x="370" y="110" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--text-primary)">Survivor 1</text>
          <text x="370" y="126" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">存活区2</text>
          ...
          <text x="580" y="115" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--text-primary)">Old</text>
          <text x="580" y="130" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">长期存活对象</text>

          {/* GC流程箭头 */}
          <text x="110" y="164" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">Minor GC（频繁）</text>
          <text x="240" y="164" textAnchor="middle" fontSize="14" fill="var(--text-tertiary)">&rarr;</text>
          <text x="370" y="164" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">复制存活</text>
          <text x="580" y="164" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">Major GC（较少）</text>
          ...
          <text x="90" y="258" fontSize="10" fill="var(--text-secondary)">年轻代GC回收率极高（80%~98%），Minor GC极短</text>
          <text x="370" y="240" fontSize="11" fontWeight="600" fill="var(--success)">老年代对象很少引用年轻代</text>
          <text x="370" y="258" fontSize="10" fill="var(--text-secondary)">Minor GC时无需扫描整个老年代，只需 remembered set</text>
          ...
          <text x="55" y="366" fontSize="9" fill="var(--text-secondary)">当 Old → Young 新增引用时</text>
          <text x="55" y="380" fontSize="9" fill="var(--text-secondary)">触发写屏障记录跨代引用</text>

          <rect x="55" y="390" width="290" height="64" rx="4" fill="var(--accent)" fillOpacity="0.06" stroke="var(--accent)" strokeWidth="0.8" />
          <text x="65" y="408" fontSize="9" fill="var(--accent)">{`if (old_field = young_ref) `}</text>
          <text x="65" y="422" fontSize="9" fill="var(--accent)">{`  card_table[addr] = dirty `}</text>
          <text x="65" y="438" fontSize="9" fill="var(--accent)">{`  // 标记对应卡为脏`}</text>
          <text x="65" y="450" fontSize="9" fill="var(--text-tertiary)">{`// Minor GC时只扫描脏卡`}</text>
          ...
          <text x="395" y="366" fontSize="9" fill="var(--text-secondary)">将老年代划分为固定大小卡（如512B）</text>
          <text x="395" y="380" fontSize="9" fill="var(--text-secondary)">每卡对应卡表一个字节</text>

          {/* 卡表示意 */}
          <rect x="395" y="392" width="28" height="24" fill="var(--text-tertiary)" fillOpacity="0.1" stroke="var(--text-tertiary)" strokeWidth="0.8" />
          <text x="409" y="408" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">0</text>
          <rect x="425" y="392" width="28" height="24" fill="var(--danger)" fillOpacity="0.3" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="439" y="408" textAnchor="middle" fontSize="8" fill="var(--danger)">1</text>
          <rect x="455" y="392" width="28" height="24" fill="var(--text-tertiary)" fillOpacity="0.1" stroke="var(--text-tertiary)" strokeWidth="0.8" />
          <text x="469" y="408" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">0</text>
          <rect x="485" y="392" width="28" height="24" fill="var(--danger)" fillOpacity="0.3" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="499" y="408" textAnchor="middle" fontSize="8" fill="var(--danger)">1</text>
          <rect x="515" y="392" width="28" height="24" fill="var(--text-tertiary)" fillOpacity="0.1" stroke="var(--text-tertiary)" strokeWidth="0.8" />
          <text x="529" y="408" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">0</text>
          <rect x="545" y="392" width="28" height="24" fill="var(--text-tertiary)" fillOpacity="0.1" stroke="var(--text-tertiary)" strokeWidth="0.8" />
          <text x="559" y="408" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">0</text>
          <rect x="575" y="392" width="28" height="24" fill="var(--danger)" fillOpacity="0.3" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="589" y="408" textAnchor="middle" fontSize="8" fill="var(--danger)">1</text>
          <rect x="605" y="392" width="28" height="24" fill="var(--text-tertiary)" fillOpacity="0.1" stroke="var(--text-tertiary)" strokeWidth="0.8" />
          <text x="619" y="408" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">0</text>
          <rect x="635" y="392" width="28" height="24" fill="var(--text-tertiary)" fillOpacity="0.1" stroke="var(--text-tertiary)" strokeWidth="0.8" />
          <text x="649" y="408" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">0</text>

          <text x="395" y="432" fontSize="9" fill="var(--text-secondary)">1 = dirty（有跨代引用）</text>
          <text x="395" y="446" fontSize="9" fill="var(--text-secondary)">0 = clean（无跨代引用）</text>
          <text x="395" y="460" fontSize="9" fill="var(--text-tertiary)">Minor GC只扫描 dirty 卡</text>
        </svg>
      </div>
