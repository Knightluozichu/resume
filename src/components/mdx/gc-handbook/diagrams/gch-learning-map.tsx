    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="205" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">三大维度：算法/性能/工程</text>
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第1章 自动内存管理起源</text>
          <text x="535" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">STW/吞吐/延迟 性能指标</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第2章 三色标记/自由链表</text>
          <text x="205" y="222" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">碎片问题/位图标记</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第3章 Cheney算法/指针追踪</text>
          <text x="535" y="222" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">From/To半区/无碎片</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第4章 滑动压缩/Two-Finger</text>
          <text x="205" y="312" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">表格法/转发指针</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第5章 弱分代假说/写屏障</text>
          <text x="535" y="312" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">卡表/ remembered set</text>
          ...
          <text x="205" y="390" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第6章 三色不变式/SATB</text>
          <text x="205" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">增量回收/读写屏障</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第7章 工作量/截止时间</text>
          <text x="535" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Metronome/Slack调度</text>
          ...
          <text x="205" y="480" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第8章 G1/ZGC/Shenandoah</text>
          <text x="205" y="492" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">CMS退场/染色指针</text>
          ...
          <text x="535" y="480" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第9章 算法选型矩阵</text>
          <text x="535" y="492" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">算法→性能→工程 完整闭环</text>
        </svg>
      </div>
