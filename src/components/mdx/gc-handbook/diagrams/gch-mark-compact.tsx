    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="67" y="93" textAnchor="middle" fontSize="11" fill="var(--text-primary)">A</text>
          <rect x="84" y="78" width="30" height="22" fill="none" stroke="var(--danger)" strokeWidth="0.8" strokeDasharray="2 2" />
          <text x="99" y="93" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">&#215;</text>
          <rect x="116" y="78" width="30" height="22" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="0.8" />
          <text x="131" y="93" textAnchor="middle" fontSize="11" fill="var(--text-primary)">C</text>
          <rect x="148" y="78" width="30" height="22" fill="none" stroke="var(--danger)" strokeWidth="0.8" strokeDasharray="2 2" />
          <text x="163" y="93" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">&#215;</text>
          <rect x="180" y="78" width="30" height="22" fill="none" stroke="var(--danger)" strokeWidth="0.8" strokeDasharray="2 2" />
          <text x="195" y="93" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">&#215;</text>
          <rect x="212" y="78" width="30" height="22" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="0.8" />
          <text x="227" y="93" textAnchor="middle" fontSize="11" fill="var(--text-primary)">E</text>
          <rect x="244" y="78" width="30" height="22" fill="none" stroke="var(--danger)" strokeWidth="0.8" strokeDasharray="2 2" />
          <text x="259" y="93" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">&#215;</text>
          <rect x="276" y="78" width="30" height="22" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="0.8" />
          <text x="291" y="93" textAnchor="middle" fontSize="11" fill="var(--text-primary)">G</text>

          <text x="185" y="120" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">A,C,E,G 存活</text>
          <text x="185" y="134" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">3个空洞 = 碎片</text>
          <text x="185" y="148" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">转发指针尚未设置</text>

          {/* 箭头 */}
          <text x="370" y="105" textAnchor="middle" fontSize="20" fill="var(--accent)">&rarr;</text>
          <text x="370" y="125" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">滑动 + 转发</text>
          ...
          <text x="620" y="93" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">连续空闲区</text>

          <text x="555" y="120" textAnchor="middle" fontSize="11" fill="var(--success)">无碎片！</text>
          <text x="555" y="134" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">存活对象向左滑动</text>
          <text x="555" y="148" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">空闲区连续可用</text>
          ...
          <text x="85" y="248" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--warning)">旧对象</text>
          <text x="85" y="262" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">header</text>

          <text x="130" y="252" textAnchor="middle" fontSize="11" fill="var(--accent)">fwd ptr</text>
          ...
          <text x="205" y="248" textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--success)">新位置</text>
          <text x="205" y="262" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">header</text>

          <text x="260" y="245" fontSize="11" fill="var(--text-secondary)">对象头中记录转发地址</text>
          <text x="260" y="258" fontSize="11" fill="var(--text-secondary)">引用更新时读旧对象头</text>
          <text x="260" y="271" fontSize="11" fill="var(--text-secondary)">跳转到新地址</text>
          ...
          <text x="55" y="364" fontSize="11" fill="var(--text-secondary)">两趟遍历：</text>
          <text x="55" y="378" fontSize="11" fill="var(--text-secondary)">① 从两端向中间找存活+空洞</text>
          <text x="55" y="392" fontSize="11" fill="var(--text-secondary)">② 将末端对象移到空洞</text>
          <text x="55" y="410" fontSize="11" fill="var(--text-tertiary)">对象顺序不保留</text>
          <text x="55" y="424" fontSize="11" fill="var(--text-tertiary)">不保证滑动→缓存差</text>
          ...
          <text x="280" y="364" fontSize="11" fill="var(--text-secondary)">多趟遍历：</text>
          <text x="280" y="378" fontSize="11" fill="var(--text-secondary)">① 计算存活对象新地址</text>
          <text x="280" y="392" fontSize="11" fill="var(--text-secondary)">② 更新所有引用</text>
          <text x="280" y="406" fontSize="11" fill="var(--text-secondary)">③ 移动对象到新位置</text>
          <text x="280" y="424" fontSize="11" fill="var(--success)">保留分配顺序→缓存友好</text>
          ...
          <text x="505" y="364" fontSize="11" fill="var(--text-secondary)">用标记位图+偏移表：</text>
          <text x="505" y="378" fontSize="11" fill="var(--text-secondary)">① 位图记录存活位置</text>
          <text x="505" y="392" fontSize="11" fill="var(--text-secondary)">② 偏移表记录新地址</text>
          <text x="505" y="410" fontSize="11" fill="var(--text-tertiary)">额外空间存偏移表</text>
          <text x="505" y="424" fontSize="11" fill="var(--text-tertiary)">适合大堆/并行化</text>
        </svg>
      </div>
