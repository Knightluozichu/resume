    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="54" y="92" textAnchor="middle" fontSize="11" fill="var(--text-primary)">A</text>
          <rect x="70" y="78" width="24" height="20" fill="var(--danger)" fillOpacity="0.3" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="82" y="92" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">B</text>
          <rect x="98" y="78" width="24" height="20" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="0.8" />
          <text x="110" y="92" textAnchor="middle" fontSize="11" fill="var(--text-primary)">C</text>
          <rect x="126" y="78" width="24" height="20" fill="var(--danger)" fillOpacity="0.3" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="138" y="92" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">D</text>
          <rect x="154" y="78" width="24" height="20" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="0.8" />
          <text x="166" y="92" textAnchor="middle" fontSize="11" fill="var(--text-primary)">E</text>

          <text x="120" y="118" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">从根集合出发遍历</text>
          <text x="120" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">可达对象标记为存活</text>
          <text x="120" y="146" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">A,C,E = 活; B,D = 死</text>
          ...
          <text x="304" y="92" textAnchor="middle" fontSize="11" fill="var(--text-primary)">A</text>
          <rect x="320" y="78" width="24" height="20" fill="none" stroke="var(--danger)" strokeWidth="0.8" strokeDasharray="2 2" />
          <text x="332" y="92" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">&#215;</text>
          <rect x="348" y="78" width="24" height="20" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="0.8" />
          <text x="360" y="92" textAnchor="middle" fontSize="11" fill="var(--text-primary)">C</text>
          <rect x="376" y="78" width="24" height="20" fill="none" stroke="var(--danger)" strokeWidth="0.8" strokeDasharray="2 2" />
          <text x="388" y="92" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">&#215;</text>
          <rect x="404" y="78" width="24" height="20" fill="var(--success)" fillOpacity="0.4" stroke="var(--success)" strokeWidth="0.8" />
          <text x="416" y="92" textAnchor="middle" fontSize="11" fill="var(--text-primary)">E</text>

          <text x="370" y="118" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">遍历整个堆</text>
          <text x="370" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">未标记对象加入自由链表</text>
          <text x="370" y="146" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">B,D 回收为空闲块</text>
          ...
          <text x="620" y="118" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">存活对象原地不动</text>
          <text x="620" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">空闲块不连续 = 碎片</text>
          <text x="620" y="146" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">大对象分配失败!</text>
          ...
          <text x="90" y="264" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">白</text>
          <text x="115" y="255" fontSize="11" fontWeight="600" fill="var(--text-primary)">White 白色</text>
          <text x="115" y="270" fontSize="11" fill="var(--text-secondary)">尚未访问</text>
          <text x="115" y="284" fontSize="11" fill="var(--text-secondary)">= 候选垃圾</text>
          ...
          <text x="310" y="264" textAnchor="middle" fontSize="11" fill="var(--text-primary)">灰</text>
          <text x="335" y="255" fontSize="11" fontWeight="600" fill="var(--accent)">Grey 灰色</text>
          <text x="335" y="270" fontSize="11" fill="var(--text-secondary)">已访问,子节点未完</text>
          <text x="335" y="284" fontSize="11" fill="var(--text-secondary)">= 工作队列中</text>
          ...
          <text x="530" y="264" textAnchor="middle" fontSize="11" fill="var(--text-primary)">黑</text>
          <text x="555" y="255" fontSize="11" fontWeight="600" fill="var(--success)">Black 黑色</text>
          <text x="555" y="270" fontSize="11" fill="var(--text-secondary)">已访问且子节点全完</text>
          <text x="555" y="284" fontSize="11" fill="var(--text-secondary)">= 确定存活</text>
          ...
          <text x="370" y="380" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">强不变式：黑色不指向白色（新增引用时灰色拦截）</text>
          <text x="370" y="394" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">弱不变式：黑色可指向白色，但被指向的白色会变灰（SATB快照）</text>
        </svg>
      </div>
