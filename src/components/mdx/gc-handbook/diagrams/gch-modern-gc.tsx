    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="95" y="60" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--text-primary)">特性</text>
          <rect x="160" y="42" width="130" height="28" rx="4" fill="var(--danger)" fillOpacity="0.08" stroke="var(--danger)" strokeWidth="0.8" />
          <text x="225" y="60" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--danger)">CMS</text>
          <rect x="290" y="42" width="130" height="28" rx="4" fill="var(--warning)" fillOpacity="0.08" stroke="var(--warning)" strokeWidth="0.8" />
          <text x="355" y="60" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--warning)">G1</text>
          <rect x="420" y="42" width="130" height="28" rx="4" fill="var(--accent)" fillOpacity="0.08" stroke="var(--accent)" strokeWidth="0.8" />
          <text x="485" y="60" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--accent)">Shenandoah</text>
          <rect x="550" y="42" width="160" height="28" rx="4" fill="var(--success)" fillOpacity="0.08" stroke="var(--success)" strokeWidth="0.8" />
          <text x="630" y="60" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--success)">ZGC</text>
          ...
          <text x="95" y="92" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">内存模型</text>
          <rect x="160" y="72" width="130" height="32" fill="var(--danger)" fillOpacity="0.04" stroke="var(--danger)" strokeWidth="0.5" />
          <text x="225" y="86" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">物理分代</text>
          <text x="225" y="98" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">连续Eden/Old</text>
          <rect x="290" y="72" width="130" height="32" fill="var(--warning)" fillOpacity="0.04" stroke="var(--warning)" strokeWidth="0.5" />
          <text x="355" y="86" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">Region分代</text>
          <text x="355" y="98" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">1-32MB Region</text>
          <rect x="420" y="72" width="130" height="32" fill="var(--accent)" fillOpacity="0.04" stroke="var(--accent)" strokeWidth="0.5" />
          <text x="485" y="86" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">Region（无分代）</text>
          <text x="485" y="98" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">Brooks指针</text>
          <rect x="550" y="72" width="160" height="32" fill="var(--success)" fillOpacity="0.04" stroke="var(--success)" strokeWidth="0.5" />
          <text x="630" y="86" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">ZPage（多粒度）</text>
          <text x="630" y="98" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">染色指针</text>
          ...
          <text x="95" y="220" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">屏障技术</text>
          <rect x="160" y="200" width="130" height="32" fill="var(--danger)" fillOpacity="0.04" stroke="var(--danger)" strokeWidth="0.5" />
          <text x="225" y="220" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">卡表写屏障</text>
          <rect x="290" y="200" width="130" height="32" fill="var(--warning)" fillOpacity="0.04" stroke="var(--warning)" strokeWidth="0.5" />
          <text x="355" y="214" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">SATB+卡表</text>
          <text x="355" y="226" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">RSet</text>
          <rect x="420" y="200" width="130" height="32" fill="var(--accent)" fillOpacity="0.04" stroke="var(--accent)" strokeWidth="0.5" />
          <text x="485" y="220" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">Brooks指针</text>
          <rect x="550" y="200" width="160" height="32" fill="var(--success)" fillOpacity="0.04" stroke="var(--success)" strokeWidth="0.5" />
          <text x="630" y="220" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">染色指针+读屏障</text>
          ...
          <text x="55" y="384" fontSize="9" fill="var(--text-secondary)">64位地址中用高位存GC状态：</text>
          <rect x="55" y="392" width="300" height="20" rx="3" fill="var(--text-primary)" fillOpacity="0.06" stroke="var(--text-tertiary)" strokeWidth="0.5" />
          <text x="205" y="406" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">{`[标记位|转发位|Remapped|...] 对象地址`}</text>

          <text x="55" y="426" fontSize="9" fill="var(--text-secondary)">读屏障检查指针颜色：</text>
          <text x="55" y="440" fontSize="9" fill="var(--success)">{`  - Marked0/Marked1 → 标记中`}</text>
          <text x="55" y="454" fontSize="9" fill="var(--success)">{`  - Remapped → 已就位`}</text>
          <text x="55" y="468" fontSize="9" fill="var(--text-tertiary)">虚拟内存多映射实现地址重定向</text>
          ...
          <text x="395" y="384" fontSize="9" fill="var(--text-secondary)">每个对象头中增加转发指针：</text>
          ...
          <text x="545" y="406" textAnchor="middle" fontSize="8" fill="var(--text-tertiary)">{`[Brooks fwd ptr] 对象数据`}</text>

          <text x="395" y="426" fontSize="9" fill="var(--text-secondary)">每次访问对象需读转发指针：</text>
          <text x="395" y="440" fontSize="9" fill="var(--accent)">{`  - fwd == self → 未移动`}</text>
          <text x="395" y="454" fontSize="9" fill="var(--accent)">{`  - fwd != self → 已移动，跳转`}</text>
          <text x="395" y="468" fontSize="9" fill="var(--text-tertiary)">额外空间开销（每对象+1指针）</text>
        </svg>
      </div>
