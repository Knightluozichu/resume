    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="370" y="266" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">类设计 + 集合 + GUI + 并发 + 网络</text>
          <text x="370" y="282" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">从语法到架构的完整链路</text>
          ...
          <text x="40" y="90" fontSize="11" fill="var(--text-secondary)">变量/类型/运算符</text>
          <text x="40" y="104" fontSize="11" fill="var(--text-secondary)">条件/循环/数组</text>
          <text x="40" y="118" fontSize="11" fill="var(--text-secondary)">方法/参数/返回值</text>
          ...
          <text x="550" y="90" fontSize="11" fill="var(--text-secondary)">类/对象/封装</text>
          <text x="550" y="104" fontSize="11" fill="var(--text-secondary)">继承/多态/接口</text>
          <text x="550" y="118" fontSize="11" fill="var(--text-secondary)">抽象类/重写</text>
          ...
          <text x="40" y="430" fontSize="11" fill="var(--text-secondary)">JFrame/布局/组件</text>
          <text x="40" y="444" fontSize="11" fill="var(--text-secondary)">监听器/事件队列</text>
          <text x="40" y="458" fontSize="11" fill="var(--text-secondary)">EDT单线程模型</text>
          ...
          <text x="550" y="430" fontSize="11" fill="var(--text-secondary)">Thread/Runnable</text>
          <text x="550" y="444" fontSize="11" fill="var(--text-secondary)">synchronized/wait</text>
          <text x="550" y="458" fontSize="11" fill="var(--text-secondary)">Socket/ServerSocket</text>
          ...
          <text x="370" y="188" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            ① 定义 Message 类（OOP）→ ② 用 ArrayList 管理消息历史（API）→ ③ JFrame 显示聊天窗口（GUI）
          </text>
          <text x="370" y="200" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
          ...
          <text x={VIEW_W / 2} y="510" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
