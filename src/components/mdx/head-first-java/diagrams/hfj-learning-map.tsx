    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="205" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第1-2章 入门基础与面向对象</text>
          <text x="205" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">变量/类/对象/方法</text>
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">能运行：掌握Java语法与类设计</text>
          <text x="535" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">能建模：理解对象与类的关系</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第3-4章 集合框架/继承/多态</text>
          <text x="205" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">ArrayList / 接口 / 重写 / 转型</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">能复用：掌握继承与多态机制</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第5-6章 窗口/组件/监听器</text>
          <text x="205" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">JFrame / JButton / 事件队列</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">能交互：构建图形界面</text>
          <text x="535" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">能响应：处理用户事件</text>
          ...
          <text x="205" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第7-8章 线程/Socket</text>
          <text x="205" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Thread / synchronized / ServerSocket</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">能并发：掌握多线程编程</text>
          <text x="535" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">能通信：理解网络编程</text>
          ...
          <text x="535" y="480" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">从Java语法到并发网络全链路</text>
          <text x="535" y="492" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">从单线程到多线程网络编程</text>
        </svg>
      </div>
