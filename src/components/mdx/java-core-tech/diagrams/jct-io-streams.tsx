    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="405" y="108" fontSize="11" fill="var(--text-secondary)">
            {" "}
            new FileReader(&quot;input.txt&quot;))) &#123;
          </text>
          <text x="405" y="124" fontSize="11" fill="var(--text-secondary)">
            {" "}
            String line;
          </text>
          <text x="405" y="140" fontSize="11" fill="var(--text-secondary)">
            {" "}
            while ((line = in.readLine()) != null) &#123;
          </text>
          <text x="405" y="156" fontSize="11" fill="var(--text-secondary)">
            {" "}
            System.out.println(line);
          </text>
          <text x="405" y="172" fontSize="11" fill="var(--text-secondary)">
            {" "}
            &#125;
          </text>
          <text x="405" y="188" fontSize="11" fill="var(--text-secondary)">
            &#125;
          </text>
          <text x="405" y="210" fontSize="11" fill="var(--text-secondary)">
            AutoCloseable: 自动关闭, 无需 finally
          </text>
          <text x="405" y="224" fontSize="11" fill="var(--text-secondary)">
            异常时自动 close(), 逆序关闭
          </text>
          ...
          <text x="45" y="342" fontSize="11" fill="var(--text-secondary)">
            Path / Files（Java 7+）:
          </text>
          ...
          <text x="45" y="474" fontSize="11" fill="var(--text-secondary)">
