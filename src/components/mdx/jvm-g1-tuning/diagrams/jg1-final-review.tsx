        ...
        >
          ...
          {[
            ...
            <g key={i}>
              ...
              <text x="80" y={r.y + 15} textAnchor="middle" fontSize="11" fontWeight="600" fill="var(--text-secondary)">{r.dim}</text>
              <text x="230" y={r.y + 15} textAnchor="middle" fontSize="11" fill="var(--warning)">{r.yg}</text>
              <text x="420" y={r.y + 15} textAnchor="middle" fontSize="11" fill="var(--accent)">{r.mg}</text>
              <text x="600" y={r.y + 15} textAnchor="middle" fontSize="11" fill="var(--danger)">{r.fg}</text>
            </g>
          ))}
          ...
          <text x="115" y="350" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Region/RSet/卡表</text>
          <text x="115" y="362" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Write Barrier</text>
          ...
          <text x="285" y="350" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">并发标记五阶段</text>
          <text x="285" y="362" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">IHOP/CSet选择</text>
          ...
          <text x="455" y="350" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Young/Mixed/Full</text>
          <text x="455" y="362" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">evacuation/退化</text>
          ...
          <text x="625" y="350" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">参数/GC日志</text>
          <text x="625" y="362" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Full GC 排查</text>
          ...
          <text x="370" y="416" textAnchor="middle" fontSize="11" fill="var(--text-tertiary)">调优结果反馈到内存模型 → 验证理解 → 深化源码认知</text>
