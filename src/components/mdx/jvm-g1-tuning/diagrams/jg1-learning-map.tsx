    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="205" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">G1架构→GC周期→调优 三层递进</text>
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第1章 设计目标/Region类型</text>
          <text x="535" y="132" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">三色标记/SATB/Garbage First</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第2章 Region大小/状态机</text>
          <text x="205" y="222" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Eden/Survivor/Old/Humongous</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第3章 反向引用索引/卡表</text>
          <text x="535" y="222" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Write Barrier/DCQ/Refine</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第4章 并发标记五阶段</text>
          <text x="205" y="312" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">IHOP/CSet选择/可预测停顿</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第5章 根扫描/RSet扫描</text>
          <text x="535" y="312" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">evacuation/PLAB/自适应策略</text>
          ...
          <text x="205" y="390" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第6章 老年代增量回收</text>
          <text x="205" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">CSet选择/终止条件/evacuation</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第7章 疏散失败/标记-整理</text>
          <text x="535" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">退化路径/避免策略</text>
          ...
          <text x="205" y="480" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第8章 参数调优/GC日志</text>
          <text x="205" y="492" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Full GC排查/大堆优化</text>
          ...
          <text x="535" y="480" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">第9章 源码对比/调优实战</text>
          <text x="535" y="492" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Region→RSet→GC周期→调优 完整闭环</text>
        </svg>
      </div>
