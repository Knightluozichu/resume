    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="160" y="106" textAnchor="middle" fontSize="10" fill="var(--text-tertiary)">已分配区</text>
          <text x="390" y="90" textAnchor="middle" fontSize="11" fill="var(--warning)">_top（分配指针）</text>
          <text x="390" y="106" textAnchor="middle" fontSize="10" fill="var(--text-tertiary)">未分配区</text>
          <text x="600" y="90" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">_end（结束地址）</text>
          <text x="600" y="106" textAnchor="middle" fontSize="10" fill="var(--text-tertiary)">RegionSize: 1-32MB</text>
          ...
          <text x="120" y="202" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">空闲可用</text>
          ...
          <text x="290" y="202" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">新对象分配</text>
          ...
          <text x="460" y="202" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">存活暂存</text>
          ...
          <text x="630" y="202" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">长期存活</text>
          ...
          <text x="204" y="180" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">分配</text>

          {/* 箭头：Eden→Survivor */}
          <line x1="350" y1="188" x2="398" y2="188" stroke="var(--text-tertiary)" strokeWidth="1.5" markerEnd="url(#arrRm)" />
          <text x="374" y="180" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">Young GC</text>

          {/* 箭头：Survivor→Old */}
          <line x1="520" y1="188" x2="568" y2="188" stroke="var(--text-tertiary)" strokeWidth="1.5" markerEnd="url(#arrRm)" />
          <text x="544" y="180" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">晋升</text>
          ...
          <text x="180" y="252" textAnchor="middle" fontSize="9" fill="var(--danger)">Young GC 回收</text>
          ...
          <text x="350" y="292" textAnchor="middle" fontSize="9" fill="var(--danger)">Mixed GC 回收</text>
          ...
          <text x="460" y="372" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Humongous Start (H) → Humongous Continuation (HC) → ... 连续多个 Region</text>

          <line x1="120" y1="358" x2="228" y2="358" stroke="var(--danger)" strokeWidth="1.5" markerEnd="url(#arrRm)" />
          <text x="174" y="350" textAnchor="middle" fontSize="9" fill="var(--danger)">大对象分配</text>
