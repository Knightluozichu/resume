    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          {Array.from({ length: 6 }, (_, i) => {
            ...
            return (
              <g key={i}>
                ...
                <text x={x + 38} y={y + 18} textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Card {i}</text>
                <text x={x + 38} y={y + 32} textAnchor="middle" fontSize="11" fill={dirty ? "var(--danger)" : "var(--text-tertiary)"}>{dirty ? "dirty" : "clean"}</text>
              </g>
            );
          })}
          ...
          <text x="455" y="108" textAnchor="middle" fontSize="11" fill="var(--danger)">Card1: obj→A</text>
          <text x="455" y="138" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">引用 Region A 的对象</text>
          ...
          <text x="635" y="108" textAnchor="middle" fontSize="11" fill="var(--danger)">Card4: obj→A</text>
          <text x="635" y="138" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">引用 Region A 的对象</text>
          ...
          <text x="330" y="108" textAnchor="middle" fontSize="11" fill="var(--warning)">RSet记录</text>
          ...
          <text x="110" y="314" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">obj.field = target</text>
          ...
          <text x="290" y="314" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">判断跨Region引用</text>
          ...
          <text x="470" y="314" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Dirty Card Queue</text>
          ...
          <text x="650" y="314" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">异步更新 RSet</text>
          ...
          <text x="145" y="410" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">精确定位每个 Card</text>
          <text x="145" y="424" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">元数据大 / 扫描精确</text>
          ...
          <text x="375" y="410" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Card 位图按 Region 分组</text>
          <text x="375" y="424" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">中等精度 / 中等开销</text>
          ...
          <text x="605" y="410" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">仅记 Region 级位图</text>
          <text x="605" y="424" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">元数据小 / 扫描放大</text>
