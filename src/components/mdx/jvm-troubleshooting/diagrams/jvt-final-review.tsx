    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="60" y="196" fontSize="11" fill="var(--text-secondary)">jps/jstat/jmap/jstack/jcmd 命令行 + MAT/Arthas/VisualVM 可视化 —— 诊断的眼睛</text>
          ...
          <text x="160" y="282" textAnchor="middle" fontSize="11" fill="var(--danger)">线程分析/死锁</text>

          <rect x="270" y="260" width="200" height="34" rx="4" fill="var(--danger)" fillOpacity="0.16" stroke="var(--danger)" strokeWidth="1" />
          <text x="370" y="282" textAnchor="middle" fontSize="11" fill="var(--danger)">内存泄漏排查</text>

          <rect x="480" y="260" width="200" height="34" rx="4" fill="var(--danger)" fillOpacity="0.16" stroke="var(--danger)" strokeWidth="1" />
          <text x="580" y="282" textAnchor="middle" fontSize="11" fill="var(--danger)">CPU性能分析</text>
          ...
          <text x="60" y="372" fontSize="11" fill="var(--text-secondary)">OOM 看 dump、CPU 高看栈顶、响应慢看等待、死锁 jstack 自动检测</text>
          ...
          <text x="140" y="462" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">黑盒重启扩容</text>
          <text x="140" y="476" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">问题反复</text>
          ...
          <text x="370" y="462" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">工具采集证据</text>
          <text x="370" y="476" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">不停机定位</text>
          ...
          <text x="600" y="462" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">理解原理主动优化</text>
          <text x="600" y="476" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">监控预防不故障</text>
        </svg>
      </div>
