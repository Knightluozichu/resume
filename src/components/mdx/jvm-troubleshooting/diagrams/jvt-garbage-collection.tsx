    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="100" y="104" textAnchor="middle" fontSize="11" fill="var(--warning)">栈局部</text>

          <circle cx="200" cy="100" r="22" fill="var(--warning)" fillOpacity="0.20" stroke="var(--warning)" strokeWidth="1.2" />
          <text x="200" y="104" textAnchor="middle" fontSize="11" fill="var(--warning)">静态属性</text>

          <circle cx="300" cy="100" r="22" fill="var(--warning)" fillOpacity="0.20" stroke="var(--warning)" strokeWidth="1.2" />
          <text x="300" y="104" textAnchor="middle" fontSize="11" fill="var(--warning)">JNI引用</text>
          ...
          <text x="80" y="176" textAnchor="middle" fontSize="11" fill="var(--success)">存活</text>

          <circle cx="180" cy="172" r="14" fill="var(--success)" fillOpacity="0.20" stroke="var(--success)" strokeWidth="1" />
          <text x="180" y="176" textAnchor="middle" fontSize="11" fill="var(--success)">存活</text>

          <circle cx="320" cy="172" r="14" fill="var(--danger)" fillOpacity="0.20" stroke="var(--danger)" strokeWidth="1" />
          <text x="320" y="176" textAnchor="middle" fontSize="11" fill="var(--danger)">回收</text>

          <text x="200" y="202" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">可达=存活，不可达=回收（解决循环引用）</text>
          ...
          <text x="550" y="96" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">简单 / 有碎片 / 老年代(CMS)</text>
          ...
          <text x="550" y="148" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">无碎片 / 内存减半 / 新生代</text>
          ...
          <text x="550" y="200" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">无碎片 / 移动慢 / 老年代</text>
          ...
          <text x="110" y="288" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">单线程</text>
          <text x="110" y="302" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">客户端/小堆</text>
          ...
          <text x="280" y="288" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">多线程吞吐优先</text>
          <text x="280" y="302" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">批处理</text>
          ...
          <text x="450" y="288" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">低停顿/有碎片</text>
          <text x="450" y="302" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">JDK14 移除</text>
          ...
          <text x="625" y="288" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Region/可预测停顿</text>
          <text x="625" y="302" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">大堆 6G+</text>
          ...
          <text x="140" y="388" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Eden 满 / 复制算法</text>
          <text x="140" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">STW 短（几ms）</text>
          ...
          <text x="350" y="388" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">老年代满/元空间满</text>
          <text x="350" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">STW 长（数秒）需避免</text>
          ...
          <text x="580" y="388" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">System.gc/担保失败</text>
          <text x="580" y="402" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">CMS并发失败/元空间不足</text>
