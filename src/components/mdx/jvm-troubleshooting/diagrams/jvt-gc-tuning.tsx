    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="190" y="100" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">减少 STW 时间</text>
          <text x="190" y="116" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">CMS/G1 并发+增量</text>
          <text x="190" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">在线服务优先</text>
          ...
          <text x="550" y="100" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">减少 GC 时间占比</text>
          <text x="550" y="116" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Parallel 一次性回收</text>
          <text x="550" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">批处理优先</text>

          <text x="370" y="168" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">业务定优先级：在线交易 &rarr; 停顿，离线计算 &rarr; 吞吐</text>
          ...
          <text x="210" y="236" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">期望最大停顿(ms)，目标非保证</text>
          ...
          <text x="545" y="236" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">堆使用率触发并发标记</text>
          ...
          <text x="210" y="288" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Region 大小，大对象调大</text>
          ...
          <text x="545" y="288" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">预留内存防疏散失败</text>
          ...
          <text x="105" y="354" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--danger)">1. jstat 确认</text>
          <text x="105" y="370" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">Full GC 频率</text>
          ...
          <text x="260" y="354" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--danger)">2. 开 GC 日志</text>
          <text x="260" y="370" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">-Xlog:gc*</text>
          ...
          <text x="415" y="354" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--danger)">3. 分析原因</text>
          <text x="415" y="370" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">看 GC 原因</text>
          ...
          <text x="570" y="354" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--danger)">4. dump+MAT</text>
          <text x="570" y="370" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">找泄漏对象</text>
          ...
          <text x="690" y="354" textAnchor="middle" fontSize="10" fontWeight="600" fill="var(--success)">5. 调参</text>
          <text x="690" y="370" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">验证</text>
          ...
          <text x="370" y="438" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Full GC 趋近 0 / Young GC 停顿在目标内 / 吞吐 &gt; 95%</text>
        </svg>
      </div>
