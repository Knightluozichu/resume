    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="205" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第1章 运行时数据区/类加载机制</text>
          <text x="205" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">双亲委派/执行引擎</text>
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第2章 堆/栈/方法区/元空间</text>
          <text x="535" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">对象布局/内存溢出</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第3章 GC Roots/可达性分析</text>
          <text x="205" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">分代收集/收集器对比</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第4章 G1/ZGC参数调优</text>
          <text x="535" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">停顿时间/吞吐量权衡</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第5章 jps/jstat/jmap/jstack</text>
          <text x="205" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">jcmd/MAT/Arthas</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第6章 线程状态/jstack dump</text>
          <text x="535" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">死锁检测/线程池</text>
          ...
          <text x="205" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第7章 MAT/Retained Heap</text>
          <text x="205" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">ThreadLocal/静态集合泄漏</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第8章 火焰图/热点定位</text>
          <text x="535" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">JIT编译/锁竞争自旋</text>
          ...
          <text x="370" y="480" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第9章 从架构到诊断——JVM故障诊断全栈技术体系整合</text>
          <text x="370" y="492" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">理论地基 / GC / 工具 / 三大故障场景 完整体系</text>
        </svg>
      </div>
