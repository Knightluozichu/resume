    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="221" y="142" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">新对象分配区</text>

          <rect x="372" y="104" width="52" height="56" rx="4" fill="var(--accent)" fillOpacity="0.08" stroke="var(--accent)" strokeWidth="1" />
          <text x="398" y="124" textAnchor="middle" fontSize="10" fill="var(--accent)">S0</text>
          <text x="398" y="142" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">1份</text>

          <rect x="428" y="104" width="52" height="56" rx="4" fill="var(--accent)" fillOpacity="0.08" stroke="var(--accent)" strokeWidth="1" />
          <text x="454" y="124" textAnchor="middle" fontSize="10" fill="var(--accent)">S1</text>
          <text x="454" y="142" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">1份</text>
          ...
          <text x="590" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">默认 2/3 堆</text>
          <text x="590" y="138" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">晋升对象/大对象</text>
          <text x="590" y="156" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">标记整理/清除</text>
          ...
          <text x="140" y="274" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">MarkWord 8B + Klass 4B</text>
          ...
          <text x="348" y="274" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">字段值（字段重排序）</text>
          ...
          <text x="536" y="274" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">8字节整数倍</text>
          ...
          <text x="200" y="380" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">堆溢出：泄漏/大对象/堆太小</text>
          ...
          <text x="530" y="380" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">元空间溢出：动态生成类过多</text>
          ...
          <text x="200" y="432" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">栈溢出：递归过深/线程过多</text>
          ...
          <text x="530" y="432" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">98%时间GC且只回收2%</text>
        </svg>
      </div>
