...
export function GlrStepFlowDiagram({
  caption,
  stage,
  stages,
}: {
    ...
    <Frame caption={caption}>
      <div role="img" aria-label={caption} className="grid gap-3">
        {stages.slice(0, stage).map((label, index) => (
          <div key={label} className="grid min-h-12 grid-cols-[2rem_1fr] items-center gap-3 rounded-control border border-border bg-bg/40 p-3">
