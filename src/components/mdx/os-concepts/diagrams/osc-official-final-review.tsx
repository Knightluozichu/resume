...
export function OscOfficialFinalReviewMapLab() {
  return <OfficialOsConceptsLab {...common} view="map" />;
}
export function OscOfficialFinalReviewExperimentLab() {
  return <OfficialOsConceptsLab {...common} view="experiment" />;
}
export function OscOfficialFinalReviewEvidenceLab() {
