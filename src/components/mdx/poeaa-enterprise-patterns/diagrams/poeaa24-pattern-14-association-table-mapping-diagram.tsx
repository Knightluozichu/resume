    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox={`0 0 ${VIEW_W} ${VIEW_H}`} role="img" aria-label="关联表映射图。多对多关系（Student ↔ Course）通过中间关联表 student_course 实现，对象侧是集合引用，表侧是两张外键组成的连接表。" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <text x={64} y={108} fontSize="10" fontFamily="monospace" fill={T.primary}>id: 1</text>
          <text x={64} y={126} fontSize="10" fontFamily="monospace" fill="#E5B567">courses: Course[]</text>
          ...
          <text x={64} y={228} fontSize="10" fontFamily="monospace" fill={T.primary}>id: 101</text>
          <text x={64} y={246} fontSize="10" fontFamily="monospace" fill="#E5B567">students: Student[]</text>
          {/* 多对多标注 */}
          <text x={128} y={168} textAnchor="middle" fontSize="10" fill="#E5B567">M : N</text>
          ...
          <text x={310} y={152} textAnchor="middle" fontSize="10" fill={T.accent}>需要中间表</text>
          {/* 表侧 */}
          ...
          <text x={396} y={108} fontSize="10" fontFamily="monospace" fill={T.primary}>id: 1 (PK)</text>
          ...
          <text x={396} y={248} fontSize="10" fontFamily="monospace" fill={T.primary}>id: 101 (PK)</text>
          {/* 中间关联表 */}
          ...
          <text x={572} y={164} fontSize="10" fontFamily="monospace" fill="#E5B567">student_id: 1</text>
          <text x={572} y={182} fontSize="10" fontFamily="monospace" fill="#E5B567">course_id: 101</text>
          {/* FK 箭头 */}
