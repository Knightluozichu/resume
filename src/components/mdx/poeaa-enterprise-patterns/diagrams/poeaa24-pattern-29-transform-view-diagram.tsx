    ...
    <figure className="mdx-figure mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox={`0 0 ${VIEW_W} ${VIEW_H}`} role="img" aria-label="转换视图结构图。Model 数据以 XML/JSON 形式提供，由 XSLT 或转换程序将其转换为 HTML 输出，视图逻辑完全在转换规则中。" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <text x={64} y={118} fontSize="9" fontFamily="monospace" fill={T.primary}>&lt;order id="42"&gt;</text>
          <text x={64} y={136} fontSize="9" fontFamily="monospace" fill={T.primary}>  &lt;total&gt;597&lt;/total&gt;</text>
          <text x={64} y={154} fontSize="9" fontFamily="monospace" fill={T.primary}>  &lt;items&gt;...&lt;/items&gt;</text>
          {/* 箭头 */}
          ...
          <text x={306} y={120} fontSize="9" fontFamily="monospace" fill={T.primary}>template match</text>
          <text x={306} y={138} fontSize="9" fontFamily="monospace" fill={T.primary}>for-each select</text>
          <text x={306} y={156} fontSize="9" fontFamily="monospace" fill={T.primary}>value-of</text>
          {/* 箭头 */}
          ...
          <text x={526} y={118} fontSize="9" fontFamily="monospace" fill={T.primary}>&lt;h1&gt;42&lt;/h1&gt;</text>
          <text x={526} y={136} fontSize="9" fontFamily="monospace" fill={T.primary}>&lt;p&gt;¥597&lt;/p&gt;</text>
          <text x={526} y={154} fontSize="9" fontFamily="monospace" fill={T.primary}>&lt;ul&gt;...&lt;/ul&gt;</text>
          {/* 底部说明 */}
