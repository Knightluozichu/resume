/**
 * <PyaMultiprocessingDiagram>：multiprocessing多进程图解。
...
export function PyaMultiprocessingDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="multiprocessing多进程图解"
        ...
        >
          ...
          <text x={VIEW_W / 2} y="320" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">
            关键洞察：想象一个厨房。GIL 就像只有一把菜刀——所有厨师（线程）只能轮流用，...
          </text>
