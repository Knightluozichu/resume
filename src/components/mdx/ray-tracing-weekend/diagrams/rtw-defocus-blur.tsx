    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox="0 0 720 400" role="img" aria-label="散焦模糊与景深示意" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <text x="120" y="262" textAnchor="middle" fontSize="11" fill="var(--accent)">光圈圆盘</text>
          {/* 三个起点 */}
          ...
          <text x="388" y="196" fontSize="11" fill="var(--text-primary)">对焦点 t（焦平面）</text>
          <text x="388" y="210" fontSize="11" fill="var(--text-secondary)">focus_dist</text>
          ...
          <text x="380" y="370" textAnchor="middle" fontSize="11" fill="var(--accent)">对焦物体（清晰）</text>
          ...
          <text x="250" y="370" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">近（模糊）</text>
          ...
          <text x="560" y="370" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">远（更模糊）</text>
          ...
          <text x="360" y="78" textAnchor="middle" fontSize="11" fill="var(--text-primary)">起点在圆盘随机采样 → 方向 = 对焦点 t − 起点；焦平面清晰，前后物体发散成光斑</text>
        </svg>
      </div>
