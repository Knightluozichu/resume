    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox="0 0 720 400" role="img" aria-label="漫反射散射方向与兰伯特余弦律" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <text x="660" y="298" fontSize="11" fill="var(--text-secondary)">表面</text>
          ...
          <text x="150" y="142" fontSize="11" fill="var(--accent)">入射光</text>
          {/* 夹角 θ */}
          <path d="M 320 200 A 30 30 0 0 1 332 232" fill="none" stroke="var(--text-secondary)" strokeWidth="1" />
          <text x="300" y="222" fontSize="11" fill="var(--text-secondary)">θ</text>

          {/* 交点 */}
          <circle cx="340" cy="280" r="4" fill="var(--text-primary)" />
          <text x="346" y="298" fontSize="11" fill="var(--text-primary)">p</text>
          ...
          <text x="376" y="194" fontSize="11" fill="var(--text-secondary)">s（随机）</text>
          ...
          <text x="384" y="190" fontSize="11" fill="var(--accent)">d=N+s</text>

          {/* 右侧：伽马校正曲线对比 */}
          <rect x="470" y="120" width="210" height="150" rx="8" fill="var(--bg)" stroke="var(--border)" strokeWidth="1" />
          <text x="575" y="138" textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--text-primary)">伽马校正</text>
          ...
          <text x="600" y="266" fontSize="11" fill="var(--text-secondary)">线性</text>
          <text x="648" y="148" fontSize="11" fill="var(--accent)">sqrt(γ=2)</text>
          ...
          <text x="360" y="372" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">散射方向天然偏向法线，分布 ∝ cosθ（兰伯特律）；输出前开平方校正亮度</text>
        </svg>
      </div>
