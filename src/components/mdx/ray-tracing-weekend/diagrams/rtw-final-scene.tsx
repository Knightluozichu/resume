    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox="0 0 720 400" role="img" aria-label="最终场景渲染示意" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <text x="660" y="346" fontSize="10" fill="var(--text-secondary)">地面（r=1000 漫反射球）</text>

          {/* 三主角 */}
          <circle cx="300" cy="288" r="40" fill="var(--accent)" fillOpacity="0.18" stroke="var(--accent)" strokeWidth="1.5" />
          <text x="300" y="292" textAnchor="middle" fontSize="9.5" fill="var(--accent)">玻璃</text>
          <circle cx="200" cy="294" r="34" fill="var(--accent)" fillOpacity="0.10" stroke="var(--accent)" strokeWidth="1.5" />
          <text x="200" y="298" textAnchor="middle" fontSize="9.5" fill="var(--accent)">哑光</text>
          <circle cx="400" cy="290" r="38" fill="var(--accent)" fillOpacity="0.14" stroke="var(--accent)" strokeWidth="1.5" />
          <text x="400" y="294" textAnchor="middle" fontSize="9.5" fill="var(--accent)">金属</text>
          ...
          <text x="80" y="160" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">相机</text>
          ...
          <text x="575" y="80" textAnchor="middle" fontSize="10.5" fontWeight="700" fill="var(--text-primary)">渲染参数</text>
          <text x="484" y="100" fontSize="10" fill="var(--text-secondary)">samples_per_pixel = 500</text>
          <text x="484" y="116" fontSize="10" fill="var(--text-secondary)">max_depth = 50</text>
          <text x="484" y="132" fontSize="10" fill="var(--text-secondary)">fov = 20°, aspect = 16:9</text>
          <text x="484" y="148" fontSize="10" fill="var(--text-secondary)">aperture = 0.1, focus = 10</text>

          <text x="360" y="380" textAnchor="middle" fontSize="10.5" fill="var(--text-primary)">材质抽样：80% 漫反射 · 15% 金属 · 5% 玻璃</text>
        </svg>
      </div>
