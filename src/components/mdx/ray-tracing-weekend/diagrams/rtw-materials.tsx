    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox="0 0 720 400" role="img" aria-label="三种材质的散射行为对比" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <text x="60" y="270" fontSize="10.5" fill="var(--text-secondary)">入射光 r_in</text>
          ...
          <g>
            ...
            <text x="150" y="120" fontSize="10" fill="var(--text-secondary)">随机方向</text>
          </g>
          ...
          <g>
            ...
            <text x="446" y="150" fontSize="10" fill="var(--text-secondary)">镜面反射</text>
          </g>
          ...
          <g>
            ...
            <text x="606" y="252" fontSize="10" fill="var(--text-secondary)">折射</text>
            <text x="606" y="150" fontSize="10" fill="var(--text-secondary)">反射</text>
          </g>
          ...
          <text x="360" y="342" textAnchor="middle" fontSize="10.5" fill="var(--text-secondary)">漫反射：方向 = N + 随机向量 · 金属：方向 = reflect(d, N) + fuzz</text>
          <text x="360" y="360" textAnchor="middle" fontSize="10.5" fill="var(--text-secondary)">电介质：按 Schlick 折射率在反射/折射间选择</text>
          <text x="360" y="376" textAnchor="middle" fontSize="10.5" fill="var(--text-primary)">ray_color 返回 attenuation * ray_color(scattered, depth-1)</text>
