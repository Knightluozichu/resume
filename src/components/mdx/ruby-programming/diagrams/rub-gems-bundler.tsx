    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="Ruby Gems 与 Bundler。Gem 是 Ruby 包，Bundler 通过 Gemfile 管理项目依赖和版本锁定。"
        ...
        >
          ...
          <rect
            ...
            strokeOpacity="0.4"
          />
          <text x={372} y={106} fontSize="12" fontWeight="700" fill={success}>
            Gemfile（声明依赖）
          </text>
          <text x={372} y={126} fontSize="11" fill={primary}>
            source &quot;https://rubygems.org&quot;
          </text>
          <text x={372} y={142} fontSize="11" fill={primary}>
            gem &quot;rails&quot;, &quot;~&gt; 7.0&quot;
          </text>
          <text x={372} y={158} fontSize="11" fill={primary}>
            gem &quot;pg&quot;, &quot;&gt;= 1.3&quot;
          </text>
          <text x={372} y={174} fontSize="11" fill={primary}>
          ...
          <rect
            ...
            strokeOpacity="0.4"
          />
          <text x={372} y={262} fontSize="12" fontWeight="700" fill={warning}>
            Gemfile.lock（版本锁定）
          </text>
          <text x={372} y={282} fontSize="11" fill={primary}>
            rails (= 7.0.4)
          </text>
          ...
          <text
            ...
            fill={secondary}
          >
            &quot;~&gt; 7.0&quot; = &gt;= 7.0 且 &lt; 8.0（允许小版本升级）·
            Gemfile.lock 保证可重现构建
          </text>
      ...
      <figcaption className="mt-2 text-center text-sm text-secondary">
        Gem 是 Ruby 包的标准格式，Bundler 通过 Gemfile 和 Gemfile.lock
        管理项目依赖与版本一致性。
      </figcaption>
    </figure>
  );
