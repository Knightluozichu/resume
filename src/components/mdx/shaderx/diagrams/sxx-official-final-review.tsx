...
export function SxxOfficialFinalReviewMapLab(){return <ShaderXSeriesLab title="ShaderX 1-7 官方总验收：329篇复现" mode="map" snapshots={SNAPSHOTS} initial={0}/>;}
export function SxxOfficialFinalReviewExperimentLab(){return <ShaderXSeriesLab title="ShaderX 1-7 官方总验收：329篇复现" mode="experiment" snapshots={SNAPSHOTS} initial={2}/>;}
export function SxxOfficialFinalReviewEvidenceLab(){return <ShaderXSeriesLab title="ShaderX 1-7 官方总验收：329篇复现" mode="evidence" snapshots={SNAPSHOTS} initial={4}/>;}
