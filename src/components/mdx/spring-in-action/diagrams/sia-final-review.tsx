    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="140" y="118" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">容器 / Bean生命周期 / 依赖注入</text>
          ...
          <text x="600" y="118" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">自动装配 / Java配置 / 组件扫描</text>
          ...
          <text x="140" y="198" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">切面 / 切点 / 通知 / 织入</text>
          ...
          <text x="600" y="198" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">DispatcherServlet / 控制器 / RESTful</text>
          ...
          <text x="140" y="358" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Repository / 实体映射 / JPQL</text>
          ...
          <text x="600" y="358" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">过滤链 / 认证 / 授权 / BCrypt</text>
          ...
          <text x="140" y="438" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">自动配置 / 起步依赖 / 内嵌容器</text>
          ...
          <text x="600" y="438" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">网关 / 注册中心 / 熔断 / 配置中心</text>
