    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="205" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第1章 容器/Bean生命周期/依赖注入</text>
          <text x="205" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">控制反转与松耦合</text>
          ...
          <text x="535" y="120" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第2章 自动装配/Java配置/组件扫描</text>
          <text x="535" y="132" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">@Autowired/@Bean/@Component</text>
          ...
          <text x="205" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第3章 切面/切点/通知/织入</text>
          <text x="205" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">横切关注点分离</text>
          ...
          <text x="535" y="210" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第4章 DispatcherServlet/控制器</text>
          <text x="535" y="222" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">视图解析/RESTful</text>
          ...
          <text x="205" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第5章 Repository/实体映射</text>
          <text x="205" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Spring Data JPA/JPQL</text>
          ...
          <text x="535" y="300" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第6章 过滤链/认证/授权</text>
          <text x="535" y="312" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">密码编码/方法级安全</text>
          ...
          <text x="205" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第7章 自动配置/起步依赖</text>
          <text x="205" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">Actuator/外部化配置</text>
          ...
          <text x="535" y="390" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第8章 服务注册/配置中心/网关</text>
          <text x="535" y="402" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">熔断/负载均衡</text>
          ...
          <text x="370" y="480" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">第9章 从IoC到微服务——Spring全栈技术体系整合</text>
          <text x="370" y="492" textAnchor="middle" fontSize="10" fill="var(--text-secondary)">核心容器 / Web / 数据 / 安全 / 云原生 完整体系</text>
        </svg>
      </div>
