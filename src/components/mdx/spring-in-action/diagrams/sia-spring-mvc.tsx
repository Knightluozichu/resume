    ...
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          ...
          <text x="75" y="98" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">HTTP请求</text>
          ...
          <text x="225" y="98" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">前端控制器（核心）</text>
          ...
          <text x="380" y="98" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">找哪个控制器</text>
          ...
          <text x="525" y="98" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">执行控制器</text>
          ...
          <text x="667" y="98" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@GetMapping等</text>
          ...
          <text x="632" y="203" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">视图名 → 模板（Thymeleaf）</text>
          ...
          <text x="432" y="203" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">渲染/组装响应</text>
          ...
          <text x="240" y="203" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">HTTP响应（JSON/HTML）</text>
          ...
          <text x="110" y="308" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@Controller</text>
          <text x="110" y="322" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@RestController</text>
          <text x="110" y="336" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@RequestMapping</text>
          <text x="110" y="350" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@GetMapping/@PostMapping</text>
          ...
          <text x="285" y="308" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@RequestParam</text>
          <text x="285" y="322" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@PathVariable</text>
          <text x="285" y="336" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@RequestBody</text>
          <text x="285" y="350" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@RequestHeader</text>
          ...
          <text x="460" y="308" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@ResponseBody</text>
          <text x="460" y="322" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">ResponseEntity</text>
          <text x="460" y="336" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@ResponseStatus</text>
          <text x="460" y="350" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@ExceptionHandler</text>
          ...
          <text x="635" y="308" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@CrossOrigin</text>
          <text x="635" y="322" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@Valid / @Validated</text>
          <text x="635" y="336" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">@ControllerAdvice</text>
          <text x="635" y="350" textAnchor="middle" fontSize="9" fill="var(--text-secondary)">全局异常处理</text>
          ...
          <text x="60" y="440" fontSize="10" fill="var(--success)">GET    /orders        </text>
          <text x="260" y="440" fontSize="10" fill="var(--text-secondary)">→ 查询订单列表</text>
          <text x="60" y="458" fontSize="10" fill="var(--warning)">POST   /orders        </text>
          <text x="260" y="458" fontSize="10" fill="var(--text-secondary)">→ 新建订单</text>
          <text x="60" y="476" fontSize="10" fill="var(--accent)">PUT    /orders/123    </text>
          <text x="260" y="476" fontSize="10" fill="var(--text-secondary)">→ 更新订单（整体替换）</text>
          <text x="430" y="440" fontSize="10" fill="var(--accent)">PATCH  /orders/123    </text>
          <text x="620" y="440" fontSize="10" fill="var(--text-secondary)">→ 部分更新</text>
          <text x="430" y="458" fontSize="10" fill="var(--danger)">DELETE /orders/123    </text>
          <text x="620" y="458" fontSize="10" fill="var(--text-secondary)">→ 删除订单</text>
          <text x="430" y="476" fontSize="10" fill="var(--text-primary)">GET    /orders/123    </text>
          <text x="620" y="476" fontSize="10" fill="var(--text-secondary)">→ 查询单个订单</text>
        </svg>
      </div>
