...
const config = {
  title: "第4章 地址解析协议",
  focus: "用缓存、请求/应答帧、代理ARP、免费ARP与地址冲突检测解释邻接解析",
  invariant: "ARP结论绑定目标协议地址、链路广播域、缓存状态、应答者与老化时间",
  failure: "把ARP当作路由协议或跨广播域机制，会错误解释代理ARP与网关MAC",
  stages: [
...
export function Tip204ArpProtocolLab() {
  return (
...
export function Tip204ArpStateLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Tip204ArpEvidenceLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
