...
const config = {
  ...
  focus: "对照ICMPv4/v6类型与代码、差错引用、查询报文、邻居发现和协议转换",
  invariant: "ICMP判断包含版本、类型、代码、被引用报文、发送限制和触发条件",
  failure: "笼统封禁ICMP会破坏PMTUD、邻居发现和错误诊断，也不能自动消除攻击面",
  stages: [
...
export function Tip208IcmpProtocolLab() {
  return (
...
export function Tip208IcmpStateLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Tip208IcmpEvidenceLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
