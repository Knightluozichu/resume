...
const config = {
  title: "第17章 TCP保活机制",
  focus: "区分TCP保活探测、应用心跳、空闲连接、失败响应与相关攻击",
  invariant: "保活结论包含空闲阈值、探测间隔、次数、序号行为与最终套接字状态",
  failure: "把保活当成及时故障检测或应用存活证明，会掩盖长计时器和半开语义",
  stages: [
...
export function Tip217TcpKeepaliveProtocolLab() {
  return (
...
export function Tip217TcpKeepaliveStateLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Tip217TcpKeepaliveEvidenceLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
