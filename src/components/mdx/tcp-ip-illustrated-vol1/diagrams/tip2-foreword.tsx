...
const config = {
  title: "推荐序",
  focus: "理解Vint Cerf对协议工程、互联网持久问题和实验性解释方法的定位",
  invariant: "阅读目标始终落到协议行为、抓包证据与可替代设计，而不是术语背诵",
  failure: "把经典地位当作无需复验的权威，会背离本书以真实系统验证协议的写法",
  stages: [
...
export function Tip2ForewordProtocolLab() {
  return (
...
export function Tip2ForewordStateLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Tip2ForewordEvidenceLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
