...
const config = {
  title: "缩略语表",
  focus: "把协议缩写映射到全称、层次、字段、状态机和首次出现章节",
  invariant: "缩写解释有唯一上下文，能反向定位定义、报文字段与正式章节",
  failure: "只记字母展开会把同名缩写和跨层概念误连",
  stages: [
...
export function Tip2GlossaryAcronymsProtocolLab() {
  return (
...
export function Tip2GlossaryAcronymsStateLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Tip2GlossaryAcronymsEvidenceLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
