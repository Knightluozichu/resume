...
const config = {
  title: "第2版权威学习地图",
  focus: "按3篇前置材料、18章、缩略语表和索引组织491个正式节点",
  invariant: "491个节点都有唯一归属页面、协议实验、复习题和相邻导航",
  failure:
    "旧10页主题课遗漏地址结构、ARP、DHCP、NAT、DNS、TCP状态与安全等正式章节",
  stages: [
...
export function Tip2OfficialLearningMapProtocolLab() {
  return (
...
export function Tip2OfficialLearningMapStateLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Tip2OfficialLearningMapEvidenceLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
