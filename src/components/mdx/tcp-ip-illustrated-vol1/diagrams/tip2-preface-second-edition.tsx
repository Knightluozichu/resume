...
const config = {
  title: "第2版前言",
  focus: "锁定第2版的Linux、Windows、Mac OS实验环境、IPv6扩展和2011年协议边界",
  invariant: "每个课程节点都能回到第2版目录与当时的协议/实现语境",
  failure: "把第1版24章结构或后来协议静默回填，会破坏版次忠实度",
  stages: [
...
export function Tip2PrefaceSecondEditionProtocolLab() {
  return (
...
export function Tip2PrefaceSecondEditionStateLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Tip2PrefaceSecondEditionEvidenceLab() {
  return (
    <Tip2ProtocolWorkbench
      {...config}
      stages={[...config.stages]}
