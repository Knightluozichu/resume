...
export function TwsOfficialFinalReviewMapLab() {
  return <OfficialTwoWeekScriptingLab {...data} view="map" />;
}

export function TwsOfficialFinalReviewExperimentLab() {
  return <OfficialTwoWeekScriptingLab {...data} view="experiment" />;
}

export function TwsOfficialFinalReviewEvidenceLab() {
