/**
 * <UctLearningMapDiagram>：Unity 核心技术全书学习地图图解。
...
export function UctLearningMapDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="Unity 核心技术全书学习地图图解"
          className="mx-auto block h-auto w-full max-w-[720px]"
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">Unity 核心技术全书学习地图</text>
      ...
      <figcaption className="mt-2 text-center text-sm text-secondary">
        Unity 核心技术全书学习地图——Unity 3D 实战核心技术
      </figcaption>
    </figure>
  );
}
