/**
 * <UctRenderingPipelineDiagram>：Unity 渲染管线图解。
...
export function UctRenderingPipelineDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="Unity 渲染管线图解"
          className="mx-auto block h-auto w-full max-w-[720px]"
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">Unity 渲染管线</text>
          <rect x="60" y="80" width="170" height="55" rx="8" fill="var(--success)" fillOpacity="0.12" stroke="var(--success)" strokeWidth="1.2" />
          <text x="145" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--success)">导入</text>
          <text x="145" y="123" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">资源导入</text>
          ...
          <text x="355" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--accent)">处理</text>
          <text x="355" y="123" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">AssetProcessor</text>
          ...
          <text x="565" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--warning)">输出</text>
          <text x="565" y="123" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">Prefab/Scene</text>
          ...
          <text x="360" y="215" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Unity 渲染管线</text>
