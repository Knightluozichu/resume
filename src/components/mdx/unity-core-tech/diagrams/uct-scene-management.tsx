/**
 * <UctSceneManagementDiagram>：Unity 场景管理图解。
...
export function UctSceneManagementDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="Unity 场景管理图解"
          className="mx-auto block h-auto w-full max-w-[720px]"
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">Unity 场景管理</text>
          <rect x="60" y="80" width="170" height="55" rx="8" fill="var(--success)" fillOpacity="0.12" stroke="var(--success)" strokeWidth="1.2" />
          <text x="145" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--success)">场景</text>
          <text x="145" y="123" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">Scene 文件</text>
          ...
          <text x="355" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--accent)">GameObject</text>
          <text x="355" y="123" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">GameObject 层级</text>
          ...
          <text x="565" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="var(--warning)">组件</text>
          <text x="565" y="123" textAnchor="middle" fontSize="9" fill="var(--text-tertiary)">Transform/MonoBehaviour</text>
          ...
          <text x="360" y="215" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">Unity 场景管理</text>
