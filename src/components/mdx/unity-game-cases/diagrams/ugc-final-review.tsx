/**
 * <UgcFinalReviewDiagram>：游戏案例开发复习与综合实践图解。
...
export function UgcFinalReviewDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="游戏案例开发复习与综合实践图解"
          className="mx-auto block h-auto w-full max-w-[720px]"
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">游戏案例开发复习与综合实践</text>
