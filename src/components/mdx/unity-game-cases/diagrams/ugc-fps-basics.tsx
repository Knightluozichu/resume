/**
 * <UgcFpsBasicsDiagram>：FPS 第一人称射击游戏基础图解。
...
export function UgcFpsBasicsDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="FPS 第一人称射击游戏基础图解"
          className="mx-auto block h-auto w-full max-w-[720px]"
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">FPS 第一人称射击游戏基础</text>
          ...
          <text x="360" y="215" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">FPS 第一人称射击游戏基础</text>
