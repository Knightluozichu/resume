/**
 * <UgcLearningMapDiagram>：Unity 游戏案例全书学习地图图解。
...
export function UgcLearningMapDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg
          ...
          role="img"
          aria-label="Unity 游戏案例全书学习地图图解"
          className="mx-auto block h-auto w-full max-w-[720px]"
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">Unity 游戏案例全书学习地图</text>
      ...
      <figcaption className="mt-2 text-center text-sm text-secondary">
        Unity 游戏案例全书学习地图——Unity 游戏案例开发大全
      </figcaption>
    </figure>
  );
}
