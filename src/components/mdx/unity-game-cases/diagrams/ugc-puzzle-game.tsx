...
export function UgcPuzzleGameDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        ...
        >
          <text x="360" y="32" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text-primary)">益智游戏</text>
          ...
          <text x="360" y="215" textAnchor="middle" fontSize="11" fill="var(--text-secondary)">益智游戏</text>
