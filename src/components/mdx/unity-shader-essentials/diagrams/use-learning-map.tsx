/**
 * <UseLearningMapDiagram>: Unity Shader 全书学习地图
 *
 * 基础管线 -> ShaderLab语法 -> 光照与效果 -> 高级技术
...
export function UseLearningMapDiagram() {
  return (
    <figure className="mdx-figure not-prose mx-auto my-6">
      <div className="overflow-hidden rounded-card border border-border bg-elevated p-5">
        <svg viewBox="0 0 720 400" role="img" aria-label="Unity Shader全书学习地图。四个板块：基础管线、ShaderLab语法、光照与效果、高级技术。" className="mx-auto block h-auto w-full max-w-[720px]">
          ...
          <g>
            ...
            <text x={52} y={92} fontSize="13" fontWeight="700" fill={accent}>基础管线</text>
            ...
            <text x={380} y={112} textAnchor="middle" fontSize="11" fontWeight="600" fill={primary}>数学基础</text>
            ...
            <text x={532} y={112} textAnchor="middle" fontSize="11" fontWeight="600" fill={primary}>坐标系变换</text>
          ...
          <g>
            ...
            <text x={532} y={190} textAnchor="middle" fontSize="11" fontWeight="600" fill={primary}>Tags/RenderSetup</text>
          ...
          <g>
            ...
            <text x={52} y={246} fontSize="13" fontWeight="700" fill={warning}>光照与效果</text>
            <rect x={158} y={246} width={140} height={33} rx="6" fill={elevated} stroke={border} strokeWidth="1" />
            <text x={228} y={266} textAnchor="middle" fontSize="11" fontWeight="600" fill={primary}>光照模型</text>
          ...
          <g>
            ...
            <text x={532} y={344} textAnchor="middle" fontSize="11" fontWeight="600" fill={primary}>噪声算法</text>
            <line x1={450} y1={340} x2={462} y2={340} stroke={border} strokeWidth="1" strokeDasharray="3 2" />
          </g>
          <defs>
            <marker id="useLearningMap-arrow" markerWidth="8" markerHeight="8" refX="4" refY="3" orient="auto">
      ...
      <figcaption className="mt-2 text-center text-sm text-secondary">
        Unity Shader 四大板块：管线是骨架，语法是工具，光照是核心，高级是目标。
      </figcaption>
    </figure>
  );
}
