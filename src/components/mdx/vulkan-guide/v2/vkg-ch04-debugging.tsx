...
const model = {
  ...
  invariant: "调试Vulkan程序的输入、状态、输出与恢复结果可用同一证据包重放",
...
export function VkgCh04DebuggingExecutionLab() {
  return <OfficialVulkanExecutionLab mode="execution" {...props} />;
}

export function VkgCh04DebuggingHazardLab() {
  return <OfficialVulkanExecutionLab mode="hazard" {...props} />;
}

export function VkgCh04DebuggingEvidenceLab() {
