...
const config = {
  title: "索引",
  focus: "把协议、字段、工具、案例、故障征兆和证据入口建立双向检索",
  invariant: "任一索引词都能到达正式节点、样例帧、过滤器和反例证据",
  failure: "主题式旧课程无法从原书术语回到真实章节，导致检索和复习断裂",
  stages: [
    {
      label: "捕获",
...
export function Ppa3IndexPacketLab() {
  return (
    <Ppa3PacketWorkbench
      {...config}
...
export function Ppa3IndexDiagnosisLab() {
  return (
    <Ppa3PacketWorkbench
      {...config}
      stages={[...config.stages]}
...
export function Ppa3IndexEvidenceLab() {
  return (
    <Ppa3PacketWorkbench
      {...config}
      stages={[...config.stages]}
