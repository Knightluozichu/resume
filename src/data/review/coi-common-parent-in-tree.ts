...
export const commonParentInTreeQuestions: ReviewQuestion[] = [
  {
    id: "coi-common-parent-in-tree-1",
    chapter: "coi-common-parent-in-tree",
    level: 1,
    question: "这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。",
    answer: "核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。递归返回命中状态，分离情况归并。",
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-common-parent-in-tree-2",
    chapter: "coi-common-parent-in-tree",
    level: 2,
  ...
  {
    id: "coi-common-parent-in-tree-3",
    chapter: "coi-common-parent-in-tree",
    level: 2,
  ...
  {
    id: "coi-common-parent-in-tree-4",
    chapter: "coi-common-parent-in-tree",
    level: 3,
  ...
  {
    id: "coi-common-parent-in-tree-5",
    chapter: "coi-common-parent-in-tree",
    level: 4,
