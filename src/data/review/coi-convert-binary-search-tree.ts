...
export const convertBinarySearchTreeQuestions: ReviewQuestion[] = [
  {
    id: "coi-convert-binary-search-tree-1",
    chapter: "coi-convert-binary-search-tree",
    level: 1,
    question: `这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。`,
    answer: `核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。中序遍历天然有序，维护前驱指针并回填双向指针。`,
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-convert-binary-search-tree-2",
    chapter: "coi-convert-binary-search-tree",
    level: 2,
  ...
  {
    id: "coi-convert-binary-search-tree-3",
    chapter: "coi-convert-binary-search-tree",
    level: 2,
  ...
  {
    id: "coi-convert-binary-search-tree-4",
    chapter: "coi-convert-binary-search-tree",
    level: 3,
  ...
  {
    id: "coi-convert-binary-search-tree-5",
    chapter: "coi-convert-binary-search-tree",
    level: 4,
