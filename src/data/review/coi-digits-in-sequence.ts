...
export const digitsInSequenceQuestions: ReviewQuestion[] = [
  {
    id: "coi-digits-in-sequence-1",
    chapter: "coi-digits-in-sequence",
    level: 1,
    question: `这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。`,
    answer: `核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。按位数分段扣减并反推目标数与位次。`,
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-digits-in-sequence-2",
    chapter: "coi-digits-in-sequence",
    level: 2,
