...
export const firstNotRepeatingCharQuestions: ReviewQuestion[] = [
  {
    id: "coi-first-not-repeating-char-1",
    chapter: "coi-first-not-repeating-char",
    level: 1,
    question: "这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。",
    answer: "核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。统计频次 + 二次线性扫描，或队列存候选。",
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-first-not-repeating-char-2",
    chapter: "coi-first-not-repeating-char",
    level: 2,
  ...
  {
    id: "coi-first-not-repeating-char-3",
    chapter: "coi-first-not-repeating-char",
    level: 2,
  ...
  {
    id: "coi-first-not-repeating-char-4",
    chapter: "coi-first-not-repeating-char",
    level: 3,
  ...
  {
    id: "coi-first-not-repeating-char-5",
    chapter: "coi-first-not-repeating-char",
    level: 4,
