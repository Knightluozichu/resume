...
export const integerIdenticalToIndexQuestions: ReviewQuestion[] = [
  {
    id: "coi-integer-identical-to-index-1",
    chapter: "coi-integer-identical-to-index",
    level: 1,
    question: `这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。`,
    answer: `核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。二分法（数组有序）或哈希（无序）。`,
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-integer-identical-to-index-2",
    chapter: "coi-integer-identical-to-index",
    level: 2,
  ...
  {
    id: "coi-integer-identical-to-index-3",
    chapter: "coi-integer-identical-to-index",
    level: 2,
  ...
  {
    id: "coi-integer-identical-to-index-4",
    chapter: "coi-integer-identical-to-index",
    level: 3,
  ...
  {
    id: "coi-integer-identical-to-index-5",
    chapter: "coi-integer-identical-to-index",
    level: 4,
