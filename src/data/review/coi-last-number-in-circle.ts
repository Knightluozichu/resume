...
export const lastNumberInCircleQuestions: ReviewQuestion[] = [
  {
    id: "coi-last-number-in-circle-1",
    chapter: "coi-last-number-in-circle",
    level: 1,
    question: `这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。`,
    answer: `核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。数学递推 f(n,m) 与迭代公式。`,
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-last-number-in-circle-2",
    chapter: "coi-last-number-in-circle",
    level: 2,
  ...
  {
    id: "coi-last-number-in-circle-3",
    chapter: "coi-last-number-in-circle",
    level: 2,
  ...
  {
    id: "coi-last-number-in-circle-4",
    chapter: "coi-last-number-in-circle",
    level: 3,
  ...
  {
    id: "coi-last-number-in-circle-5",
    chapter: "coi-last-number-in-circle",
    level: 4,
