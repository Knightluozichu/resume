...
export const maxValueOfGiftsQuestions: ReviewQuestion[] = [
  {
    id: "coi-max-value-of-gifts-1",
    chapter: "coi-max-value-of-gifts",
    level: 1,
    question: "这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。",
    answer: "核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。动态规划，原地复用减少空间。",
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-max-value-of-gifts-2",
    chapter: "coi-max-value-of-gifts",
    level: 2,
