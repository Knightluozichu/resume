...
export const moreThanHalfNumberQuestions: ReviewQuestion[] = [
  {
    id: "coi-more-than-half-number-1",
    chapter: "coi-more-than-half-number",
    level: 1,
    question: `这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。`,
    answer: `核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。摩尔投票法：配对抵消，最后候选值再校验。`,
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-more-than-half-number-2",
    chapter: "coi-more-than-half-number",
    level: 2,
  ...
  {
    id: "coi-more-than-half-number-3",
    chapter: "coi-more-than-half-number",
    level: 2,
  ...
  {
    id: "coi-more-than-half-number-4",
    chapter: "coi-more-than-half-number",
    level: 3,
  ...
  {
    id: "coi-more-than-half-number-5",
    chapter: "coi-more-than-half-number",
    level: 4,
