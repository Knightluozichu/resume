...
export const numberAppearingOnceQuestions: ReviewQuestion[] = [
  {
    id: "coi-number-appearing-once-1",
    chapter: "coi-number-appearing-once",
    level: 1,
    question: "这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。",
    answer: "核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。位运算异或（A ^ A = 0，A ^ 0 = A）。",
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-number-appearing-once-2",
    chapter: "coi-number-appearing-once",
    level: 2,
  ...
  {
    id: "coi-number-appearing-once-3",
    chapter: "coi-number-appearing-once",
    level: 2,
  ...
  {
    id: "coi-number-appearing-once-4",
    chapter: "coi-number-appearing-once",
    level: 3,
  ...
  {
    id: "coi-number-appearing-once-5",
    chapter: "coi-number-appearing-once",
    level: 4,
