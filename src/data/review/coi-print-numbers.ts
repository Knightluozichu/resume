...
export const coiPrintNumbersQuestions: ReviewQuestion[] = [
  {
    ...
    level: 1,
    question: "在面试中，『打印从 1 到最大的 n 位数』这道题最核心、最容易被忽略的隐藏考点是什么？",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 1,
    question: "为什么当 $n$ 很大时，用常规的整型自增循环打印会失效？各种语言的数值类型有什么局限？",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 2,
    question: "为了绕过整型溢出，我们如何用字符串或字符数组来模拟大数的自增？请简述其递增逻辑。",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 2,
    question: "相比于模拟大数自增，利用『全排列 + 回溯递归』生成 $n$ 位数的核心思想是什么？",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 3,
    question: "在全排列回溯生成大数时，如何去除前导零（leading zeros）？如何避免把全零（如 '000'）加入有效结果中？",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 3,
    question: "使用全排列回溯算法生成并打印所有 $n$ 位大数，其时间复杂度和空间复杂度分别是多少？请说明理由。",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 3,
    question: "在递归回溯生成数字的过程中，递归栈的最大深度是多少？它是如何被限制在 $n$ 以内的？",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 4,
    question: "请给出在 TypeScript 中使用递归回溯（大数版）生成所有最大为 $n$ 位数并输出字符串数组的完整实现代码。",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 4,
    question: "在进行数字全排列时，如何直接在递归中「剪枝」或直接按顺序构造无前导零的字符串，而不是生成后再做 slice？",
    answer:
  ...
  },
  {
    ...
    chapter: "coi-print-numbers",
    level: 4,
    question: "如果 $n$ 非常大（例如 $n = 10^5$ 且只需要计算部分片段），递归回溯会导致系统栈溢出（Stack Overflow），应如何解决？",
    answer:
