...
export const printTreesInZigzagQuestions: ReviewQuestion[] = [
  {
    id: "coi-print-trees-in-zigzag-1",
    chapter: "coi-print-trees-in-zigzag",
    level: 1,
    question: "这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。",
    answer: "核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。双端队列或双栈配合层边界，实现方向翻转。",
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-print-trees-in-zigzag-2",
    chapter: "coi-print-trees-in-zigzag",
    level: 2,
  ...
  {
    id: "coi-print-trees-in-zigzag-3",
    chapter: "coi-print-trees-in-zigzag",
    level: 2,
  ...
  {
    id: "coi-print-trees-in-zigzag-4",
    chapter: "coi-print-trees-in-zigzag",
    level: 3,
  ...
  {
    id: "coi-print-trees-in-zigzag-5",
    chapter: "coi-print-trees-in-zigzag",
    level: 4,
