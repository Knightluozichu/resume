...
export const sortArrayForMinNumberQuestions: ReviewQuestion[] = [
  {
    id: "coi-sort-array-for-min-number-1",
    chapter: "coi-sort-array-for-min-number",
    level: 1,
    question: `这道题的目标约束是什么？先说出你能提炼的 1~2 条关键约束。`,
    answer: `核心约束是：正确性覆盖所有输入范围，且在给定复杂度上限内完成。通常包括空输入、单元素、重复元素和上/下界值。比较 ab 与 ba 决定顺序，避免整数溢出。`,
    tags: ["边界条件", "复杂度"],
  },
  {
    id: "coi-sort-array-for-min-number-2",
    chapter: "coi-sort-array-for-min-number",
    level: 2,
  ...
  {
    id: "coi-sort-array-for-min-number-3",
    chapter: "coi-sort-array-for-min-number",
    level: 2,
  ...
  {
    id: "coi-sort-array-for-min-number-4",
    chapter: "coi-sort-array-for-min-number",
    level: 3,
  ...
  {
    id: "coi-sort-array-for-min-number-5",
    chapter: "coi-sort-array-for-min-number",
    level: 4,
