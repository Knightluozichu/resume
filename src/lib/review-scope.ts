...
const PREFIX_TO_BOOK: Array<[string, string]> = [
  ["ga2-", "grokking-algorithms-2e"],
  ["adp-", "android-design-patterns"],
  ["aad8-", "android-advanced-decryption"],
  ...
  ["uan-", "unity-animation"],
  ["uvf-", "unity-vfx"],
  ["usg-", "unity-scripting-game-dev"],
  ["ums-", "unity-master"],
  ["u3ap-", "unity-advanced-programming"],
  ...
  ["mfc-", "mfc-deep-dive"],
  ["wkp-", "windows-kernel-programming"],
  ["lke-", "linux-kernel-essence"],
  ["lkd-", "linux-kernel-design"],
  ["uap-", "unix-advanced-programming"],
  ["hfj-", "head-first-java"],
  ["jct-", "java-core-tech"],
  ["ejv-", "effective-java"],
  ...
  ["cra-", "crazy-android"],
  ["cra4-", "crazy-android"],
  ["kdg1-", "kotlin-definitive-guide"],
  ["adae15-", "android-art-exploration"],
  ["kia-", "kotlin-in-action"],
  ["aca-", "android-component-arch"],
  ["apo-", "android-perf-optimization"],
  ["jpc-", "jetpack-compose"],
  ["aal-", "android-advanced-light"],
  ["dak-", "deep-android-kernel"],
  ["dav-", "deep-android-volumes"],
  ["mse-", "mysql-essentials"],
  ["sqt-", "sql-ten-minutes"],
  ["dsc-", "database-system-concepts"],
  ["hpm-", "high-performance-mysql"],
  ["ddi-", "ddia"],
  ...
  ["isn-", "illustrated-server-network"],
  ["cnt-", "computer-networks-top-down"],
  ["hdg-", "http-definitive-guide"],
  ["wpa-", "wireshark-packet-analysis"],
  ["tip-", "tcp-ip-illustrated-vol1"],
  ...
  ["dlr-", "deep-learning-rl-from-scratch"],
  ["dlg-", "deep-learning-gen-models"],
  ["dlt-", "deep-learning-textbook"],
  ["prl-", "pattern-recognition-ml"],
  ["rlc-", "rl-deep-learning-c"],
  ["drl-", "deep-reinforcement-learning"],
  ["pil4-", "lua-programming"],
  ["tr5-", "ruby-programming"],
  ["dsvc-", "data-structures-visual"],
  ["tcg-", "this-is-chatgpt"],
  ["lae-", "llm-app-dev-essentials"],
  ["lcp-", "langchain-programming"],
  ["cgpt-", "chatgpt-principles-practice"],
  ["llm-", "large-language-models"],
  ["lsl-", "large-scale-llm-practice"],
  ["bla-", "building-llm-applications"],
  ["mas-", "multiagent-systems"],
  ["bp-", "blockchain-plain"],
  ["bdp-", "blockchain-dev-practice"],
  ["mbt-", "mastering-bitcoin"],
  ["met-", "mastering-ethereum"],
  ["ine-", "illustrated-nev"],
  ["csi-", "car-structure-illustrated"],
  ["avc2-", "autosar-vehicle-controller"],
  ["aes23-", "soa-vehicle-architecture"],
  ["tmm40-", "mythical-man-month"],
  ["cc2e-", "code-complete-2e"],
  ["pp-", "programming-pearls"],
  ["tpp20-", "pragmatic-programmer"],
  ["poeaa24-", "poeaa-enterprise-patterns"],
  ["taoup-", "art-of-unix-programming"],
  ["crv18-", "coder-revolution"],
  ["mis18-", "make-it-stick"],
  ["msg17-", "mindset-growth"],
  ["pdp16-", "peak-deliberate-practice"],
  ["ooc-", "out-of-control"],
  ["eex-", "effective-executive"],
  ["opt-", "org-problem-tools"],
];
